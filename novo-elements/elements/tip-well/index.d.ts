...
declare class NovoTipWellElement implements OnInit {
    private labels;
    private sanitizer;
    name: string | number;
    tip: string;
...
declare class NovoTipWellModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<NovoTipWellModule, [typeof NovoTipWellElement], [typeof i2.CommonModule, typeof i3.NovoButtonModule], [typeof NovoTipWellElement]>;

...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.19", ngImport: i0, type: NovoTooltip, decorators: [{
            type: Component,
            args: [{ selector: 'novo-tooltip', host: {
                        '[class]': 'customClass',
                    }, animations: [
                        trigger('state', [
                            state('initial, void, hidden', style({ opacity: '0' })),

...
class NovoValueElement {
  ...
  `, isInline: true, styles: [":host{display:flex;flex-direction:row;max-width:500px;justify-content:space-between;align-items:flex-start;width:max-content;padding:8px}:host i.person{color:var(--color-person)}:host i.company{color:var(--color-company)}:host i.candidate{color:var(--color-candidate)}:host i.navigation{color:var(--color-navigation)}:host i.lead{color:var(--color-lead)}:host i.contact{color:var(--color-contact)}:host i.clientcontact{color:var(--color-clientcontact)}:host i.opportunity{color:var(--color-opportunity)}:host i.job{color:var(--color-job)}:host i.joborder{color:var(--color-joborder)}:host i.submission{color:var(--color-submission)}:host i.sendout{color:var(--color-sendout)}:host i.placement{color:var(--color-placement)}:host i.note{color:var(--color-note)}:host i.task{color:var(--color-task)}:host i.distributionList{color:var(--color-distribution-list)}:host i.credential{color:var(--color-credential)}:host i.user{color:var(--color-user)}:host i.contract{color:var(--color-contract)}:host i.jobCode{color:var(--color-job-code)}:host i.earnCode{color:var(--color-earn-code)}:host i.billableCharge{color:var(--color-billable-charge)}:host i.payableCharge{color:var(--color-payable-charge)}:host i.invoiceStatement{color:var(--color-invoice-statement)}:host.horizontal{width:100%;max-width:100%}:host.horizontal .value-outer{display:grid;width:100%;grid-template-columns:minmax(120px,30%) 1fr}:host .value-outer{display:flex;flex-direction:column;gap:.4rem}:host .actions i{cursor:default;color:#9e9e9e;margin-left:15px;margin-top:7px}:host .actions i.clickable{cursor:pointer;color:var(--color-positive)}:host .actions.clickable{cursor:pointer;color:var(--color-positive)}:host ::ng-deep novo-entity-list{display:block}:host ::ng-deep novo-entity-list i.person{color:var(--color-person)}:host ::ng-deep novo-entity-list i.company{color:var(--color-company)}:host ::ng-deep novo-entity-list i.candidate{color:var(--color-candidate)}:host ::ng-deep novo-entity-list i.navigation{color:var(--color-navigation)}:host ::ng-deep novo-entity-list i.lead{color:var(--color-lead)}:host ::ng-deep novo-entity-list i.contact{color:var(--color-contact)}:host ::ng-deep novo-entity-list i.clientcontact{color:var(--color-clientcontact)}:host ::ng-deep novo-entity-list i.opportunity{color:var(--color-opportunity)}:host ::ng-deep novo-entity-list i.job{color:var(--color-job)}:host ::ng-deep novo-entity-list i.joborder{color:var(--color-joborder)}:host ::ng-deep novo-entity-list i.submission{color:var(--color-submission)}:host ::ng-deep novo-entity-list i.sendout{color:var(--color-sendout)}:host ::ng-deep novo-entity-list i.placement{color:var(--color-placement)}:host ::ng-deep novo-entity-list i.note{color:var(--color-note)}:host ::ng-deep novo-entity-list i.task{color:var(--color-task)}:host ::ng-deep novo-entity-list i.distributionList{color:var(--color-distribution-list)}:host ::ng-deep novo-entity-list i.credential{color:var(--color-credential)}:host ::ng-deep novo-entity-list i.user{color:var(--color-user)}:host ::ng-deep novo-entity-list i.contract{color:var(--color-contract)}:host ::ng-deep novo-entity-list i.jobCode{color:var(--color-job-code)}:host ::ng-deep novo-entity-list i.earnCode{color:var(--color-earn-code)}:host ::ng-deep novo-entity-list i.billableCharge{color:var(--color-billable-charge)}:host ::ng-deep novo-entity-list i.payableCharge{color:var(--color-payable-charge)}:host ::ng-deep novo-entity-list i.invoiceStatement{color:var(--color-invoice-statement)}:host ::ng-deep novo-entity-list .entity{padding-top:6px;padding-bottom:6px}:host ::ng-deep novo-entity-list i{margin-right:6px}\n"], dependencies: [{ kind: "directive", type: i1$1.NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { kind: "directive", type: i1$1.NgForOf, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }, { kind: "directive", type: i1$1.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "directive", type: i1$1.NgSwitch, selector: "[ngSwitch]", inputs: ["ngSwitch"] }, { kind: "directive", type: i1$1.NgSwitchCase, selector: "[ngSwitchCase]", inputs: ["ngSwitchCase"] }, { kind: "directive", type: i1$1.NgSwitchDefault, selector: "[ngSwitchDefault]" }, { kind: "component", type: i2$1.NovoText, selector: "novo-text,[novo-text]", inputs: ["block"] }, { kind: "component", type: i2$1.NovoLabel, selector: "novo-label,[novo-label]", inputs: ["id"] }, { kind: "component", type: i3.NovoIconComponent, selector: "novo-icon", inputs: ["raised", "theme", "shape", "color", "size", "smaller", "larger", "alt", "name"] }, { kind: "component", type: EntityList, selector: "novo-entity-list", inputs: ["data", "meta"] }, { kind: "pipe", type: RenderPipe, name: "render" }] }); }
}
__decorate([
    BooleanInput(),
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.19", ngImport: i0, type: NovoValueElement, decorators: [{
  ...
  `, standalone: false, styles: [":host{display:flex;flex-direction:row;max-width:500px;justify-content:space-between;align-items:flex-start;width:max-content;padding:8px}:host i.person{color:var(--color-person)}:host i.company{color:var(--color-company)}:host i.candidate{color:var(--color-candidate)}:host i.navigation{color:var(--color-navigation)}:host i.lead{color:var(--color-lead)}:host i.contact{color:var(--color-contact)}:host i.clientcontact{color:var(--color-clientcontact)}:host i.opportunity{color:var(--color-opportunity)}:host i.job{color:var(--color-job)}:host i.joborder{color:var(--color-joborder)}:host i.submission{color:var(--color-submission)}:host i.sendout{color:var(--color-sendout)}:host i.placement{color:var(--color-placement)}:host i.note{color:var(--color-note)}:host i.task{color:var(--color-task)}:host i.distributionList{color:var(--color-distribution-list)}:host i.credential{color:var(--color-credential)}:host i.user{color:var(--color-user)}:host i.contract{color:var(--color-contract)}:host i.jobCode{color:var(--color-job-code)}:host i.earnCode{color:var(--color-earn-code)}:host i.billableCharge{color:var(--color-billable-charge)}:host i.payableCharge{color:var(--color-payable-charge)}:host i.invoiceStatement{color:var(--color-invoice-statement)}:host.horizontal{width:100%;max-width:100%}:host.horizontal .value-outer{display:grid;width:100%;grid-template-columns:minmax(120px,30%) 1fr}:host .value-outer{display:flex;flex-direction:column;gap:.4rem}:host .actions i{cursor:default;color:#9e9e9e;margin-left:15px;margin-top:7px}:host .actions i.clickable{cursor:pointer;color:var(--color-positive)}:host .actions.clickable{cursor:pointer;color:var(--color-positive)}:host ::ng-deep novo-entity-list{display:block}:host ::ng-deep novo-entity-list i.person{color:var(--color-person)}:host ::ng-deep novo-entity-list i.company{color:var(--color-company)}:host ::ng-deep novo-entity-list i.candidate{color:var(--color-candidate)}:host ::ng-deep novo-entity-list i.navigation{color:var(--color-navigation)}:host ::ng-deep novo-entity-list i.lead{color:var(--color-lead)}:host ::ng-deep novo-entity-list i.contact{color:var(--color-contact)}:host ::ng-deep novo-entity-list i.clientcontact{color:var(--color-clientcontact)}:host ::ng-deep novo-entity-list i.opportunity{color:var(--color-opportunity)}:host ::ng-deep novo-entity-list i.job{color:var(--color-job)}:host ::ng-deep novo-entity-list i.joborder{color:var(--color-joborder)}:host ::ng-deep novo-entity-list i.submission{color:var(--color-submission)}:host ::ng-deep novo-entity-list i.sendout{color:var(--color-sendout)}:host ::ng-deep novo-entity-list i.placement{color:var(--color-placement)}:host ::ng-deep novo-entity-list i.note{color:var(--color-note)}:host ::ng-deep novo-entity-list i.task{color:var(--color-task)}:host ::ng-deep novo-entity-list i.distributionList{color:var(--color-distribution-list)}:host ::ng-deep novo-entity-list i.credential{color:var(--color-credential)}:host ::ng-deep novo-entity-list i.user{color:var(--color-user)}:host ::ng-deep novo-entity-list i.contract{color:var(--color-contract)}:host ::ng-deep novo-entity-list i.jobCode{color:var(--color-job-code)}:host ::ng-deep novo-entity-list i.earnCode{color:var(--color-earn-code)}:host ::ng-deep novo-entity-list i.billableCharge{color:var(--color-billable-charge)}:host ::ng-deep novo-entity-list i.payableCharge{color:var(--color-payable-charge)}:host ::ng-deep novo-entity-list i.invoiceStatement{color:var(--color-invoice-statement)}:host ::ng-deep novo-entity-list .entity{padding-top:6px;padding-bottom:6px}:host ::ng-deep novo-entity-list i{margin-right:6px}\n"] }]
        }], propDecorators: { data: [{
                type: Input
            }], meta: [{
                type: Input

...
export class ToastDemoComponent {
  ...
  private positions: Array<string> = ['fixedTop', 'fixedBottom', 'growlTopLeft', 'growlTopRight', 'growlBottomLeft', 'growlBottomRight'];
  private themes: Array<string> = ['default', 'success', 'info', 'warning', 'danger'];
  private icons: Array<string> = ['add', 'check', 'clock', 'lock', 'caution'];
  private options: any = {
    title: 'Title',

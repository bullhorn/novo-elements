...
import { CalendarEvent, CalendarEventResponse, NovoLabelService } from 'novo-elements';
// APP
...
`;
@Component({
  providers: [{ provide: LOCALE_ID, useValue: 'en-GB' }, { provide: NovoLabelService, useClass: ExtendedLabelService }],

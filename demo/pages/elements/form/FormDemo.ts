...
export class FormDemoComponent {
    ...
    constructor(private formUtils: FormUtils) {
        ...
        this.multiFileControl = new FileControl({ key: 'files', name: 'myfiles', label: 'Multiple Files', multiple: true, layoutOptions: { order: 'displayFilesBelow', download: false, boxedLabel: false }, value: [{ name: 'yourFile.pdf', loaded: true }] });

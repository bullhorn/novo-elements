...
<p><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> When representing scheduled events or a history of actions.</novo-text></p>
...
<ul class="contains-do-list">
<li class="bullhorn-do-item">
<p><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Don't use to select a date or range of dates.</novo-text></p>
...
<h3>Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Providing supporting visual content, e.g., an image or chart, within the context of a larger composition</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> The content provided doesn't block the workflow of the previous context.</novo-text></li>
</ul>
</div>
<div>
<h3>Don′t Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> The content of the aside requires immediate action or response. Instead, use a modal.</novo-text></li>
</ul>
</div>
</novo-grid>
<h2>Best Practices</h2>
...
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Form Slideout</novo-text></li>
</ul>
...
<div class="p"><img src="https://via.placeholder.com/350x250" alt="placeholder"></div>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Record Preview</novo-text></li>
</ul>
...
<h3>Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> A list of possible values are known but not required.</novo-text></li>
</ul>
</div>
<div>
<h3>Don′t Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> The form field requires the value to be one of the predefined options. use a select or picker instead.</novo-text></li>
</ul>
</div>
</novo-grid>
<h2>Best Practices</h2>
...
<h3>Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> When the system has more than two layers in a hierarchy.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> When you need to inform the user of where they are.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> When the user may need to navigate back to a higher level.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> When the application has multi-layer architecture.</novo-text></li>
</ul>
<h2>Best Practices</h2>
<ul>
<li>Ensure the content opened is highly correlated to the context that opened it. When showing a preview of a related content that can opened for various contexts, present the user with the data related to the context that opened it, rather than the same view.</li>
...
<h3>Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Affording interaction to key behaviors and features.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Confirming or submitting information entered into a form.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Cancelling an action.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Resetting a form or dataset.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Closing a container or section.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Opening a popover.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Moving forward or backward through a stepper workflow.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Creating an object within a group.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Applying a non-critical action to a dataset.</novo-text></li>
</ul>
</div>
<div>
<h3>Don′t Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Displaying a collection of links to sections. Use links instead.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Linking to an external site. Use links instead.</novo-text></li>
</ul>
</div>
</novo-grid>
<h2>Anatomy</h2>
...
<ul class="contains-do-list">
<li class="bullhorn-do-item">
<p><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> When the user needs to select a date to control or filter data on the page.</novo-text></p>
...
<ul class="contains-do-list">
<li class="bullhorn-do-item">
<p><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> When you are capturing dates as part of a Form.</novo-text></p>
...
<div class="p"><img src="https://via.placeholder.com/350x250" alt="placeholder"></div>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Always do this</novo-text></li>
</ul>
...
<div class="p"><img src="https://via.placeholder.com/350x250" alt="placeholder"></div>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Never do this</novo-text></li>
</ul>
<div class="p">Explain this</div>
</blockquote>
</novo-grid>
...
<h3>Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> A user must enter text data</novo-text></li>
</ul>
</div>
<div>
<h3>Don′t Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Gathering multiple lines of text. Instead, use a text area.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Selecting value from preset list, use a select or radio.</novo-text></li>
</ul>
</div>
</novo-grid>
<h2>Anatomy</h2>
...
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Additional context for action is required.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Help user easily identify what action does.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Help identify state, ie. error, warning, etc.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Spacing is limited.</novo-text></li>
</ul>
</div>
<img src="https://via.placeholder.com/350x250"/>
</novo-grid>
...
<h3>Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Loading content.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Processing an long running action.</novo-text></li>
</ul>
</div>
<div>
<h3>Don′t Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> When not loading data.</novo-text></li>
</ul>
</div>
</novo-grid>
<h2>Anatomy</h2>
...
<h3>Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Displaying multiple actions to perform on an item or selection</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Processing an long running action.</novo-text></li>
</ul>
</div>
<div>
<h3>Don′t Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> To select a value, use a select</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Top Level Page Actions, use a Dropdown.</novo-text></li>
</ul>
</div>
</novo-grid>
<h2>Anatomy</h2>
...
<ul class="contains-do-list">
<li class="bullhorn-do-item">
<p><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Do use to confirm irreversible actions:</novo-text></p>
...
<li class="bullhorn-do-item">
<p><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Do use to confirm actions that will affect other records:</novo-text></p>
...
<li class="bullhorn-do-item">
<p><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Do use for a task related to the main content:</novo-text></p>
...
<ul class="contains-do-list">
<li class="bullhorn-do-item">
<p><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Don’t use to confirm an action that has already happened:</novo-text></p>
...
<li class="bullhorn-do-item">
<p><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Don’t use for a task unrelated to the main content:</novo-text></p>
...
<ul class="contains-do-list">
<li class="bullhorn-do-item">
<p><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Do Use Multiple Columns to make content digestible:</novo-text></p>
...
<li class="bullhorn-do-item">
<p><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Don’t Use a lot of scrolling in a narrow space:</novo-text></p>
...
<div class="p"><img src="https://via.placeholder.com/350x250" alt="placeholder"></div>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Do use color to relate modals in a multi-step workflow:</novo-text></li>
</ul>
...
<div class="p"><img src="https://via.placeholder.com/350x250" alt="placeholder"></div>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Don’t use an Entity Color for something unrelated:</novo-text></li>
</ul>
...
<ul class="contains-do-list">
<li class="bullhorn-do-item">
<p><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Do use multiple avenues to convey meaning</novo-text></p>
...
<li class="bullhorn-do-item">
<p><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Don’t rely on just color to convey meaning</novo-text></p>
...
<h3>Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Content is missing from a page and you need to communicate why.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> A user is starting a new workflow and hasn’t created any content yet.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> A user has nothing more to do. For example, when they have completed all tasks, read all messages, or seen all notifications</novo-text></li>
</ul>
</div>
<div>
<h3>Don′t Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> tbw</novo-text></li>
</ul>
</div>
</novo-grid>
<h2>Anatomy</h2>
...
<h3>Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Displaying supplementary content or actions, without obscuring the page.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Creating a menu by placing a list group inside of a popover.</novo-text></li>
</ul>
</div>
<div>
<h3>Don′t Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> When content is 10 words or fewer. Instead, use a tooltip.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Requiring a user to complete a complex task. Instead, use a modal or a separate page.</novo-text></li>
</ul>
</div>
</novo-grid>
<h2>Anatomy</h2>
...
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Processing an long running action.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Displaying metrics data that can be represents as a bar.</novo-text></li>
</ul>
</div>
<div>
<h3>Don′t Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Loading content.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> To show page loading state, use (loading)[../loading].</novo-text></li>
</ul>
</div>
</novo-grid>
`,
...
<p><code-example example="table-basic"></code-example></p>
`,
  host: { class: 'markdown-page' }
})
...
<h3>Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> The help text is no longer needed after the user has read the contents.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> To provide additional context and links related to the data to educate the user on how the a feature works.</novo-text></li>
</ul>
</div>
<div>
<h3>Don′t Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Don’t use it show error states, use novo-error or a banner.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Don’t use it to display tutorials.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Don’t use it to explain text fields, use novo-hint.</novo-text></li>
</ul>
</div>
</novo-grid>
<h2>Anatomy</h2>
...
<h3>Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Use a Banner when a form cannot be saved to show an error occurred.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Use a Banner when an action can’t be completed due to an error or failure.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Use a Growl when an action is successfully performed and the context, i.e. modal, is no longer available.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> When an action happens asynchronously, e.g. file upload.</novo-text></li>
</ul>
</div>
<div>
<h3>Don′t Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Don’t use it to confirm an action, a toast should be reactive not pro-active.</novo-text></li>
</ul>
</div>
</novo-grid>
<h2>Anatomy</h2>
...
<h3>Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> The page needs navigation to its various sections.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> The page needs to set the context of the page (ie. header with title)</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Global Actions, preferences, setting, filters need to be displayed.</novo-text></li>
</ul>
</div>
<div>
<h3>Don′t Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Don't use to divide/separate content.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Don’t use it to display multi-line text content.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Don't use it for background color only.</novo-text></li>
</ul>
</div>
</novo-grid>
<h2>Anatomy</h2>
...
<ul>
<li><a href="#/components/tooltip/design#anatomy">Anatomy</a></li>
<li><a href="#/components/tooltip/design#options">Options</a></li>
<li><a href="#/components/tooltip/design#variants">Variants</a></li>
<li><a href="#/components/tooltip/design#behaviors">Behaviors</a></li>
<li><a href="#/components/tooltip/design#usage">Usage Guidelines</a></li>
<li><a href="#/components/tooltip/design#content">Content Standards</a></li>
</ul>
<h2 id="anatomy">Anatomy <a href=".#anatomy">#</a></h2>
...
<h2 id="usage">Usage Guidelines <a href="#usage">#</a></h2>
<blockquote class="img-first">
<div class="p"><img src="assets/images/TooltipGoodUsage.png" alt="Good Usage" class="good"></div>
<div class="p"><strong>Use when providing a short description</strong></div>
<div class="p">Page elements or controls such as buttons and form fields should use tooltips for context.</div>
</blockquote>
<blockquote class="img-first">
<div class="p"><img src="assets/images/TooltipBadUsage.png" alt="Bad Usage" class="bad"></div>
<div class="p"><strong>Don't use for describing supplemental information</strong></div>
<div class="p">Consider using a <a href="#components/pop%20over/design">popover</a> instead.</div>
</blockquote>
<h3>Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item">
<p><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Providing a short description of a page element or control.</novo-text></p>
<p>Page elements or contorls such as buttons and form fields can use tooltips for context.</p>
</li>
<li class="bullhorn-do-item">
<p><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Describing the action of an icon-only button.</novo-text></p>
<p>In case icon images are hard to view or do not load, tooltips are used to describe their actions.</p>
</li>
<li class="bullhorn-do-item">
<p><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Revealing the full text of truncated data.</novo-text></p>
...
<ul class="contains-do-list">
<li class="bullhorn-do-item">
<p><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Don't use for describing supplemental information.</novo-text></p>
<p>Consider using a <a href="#components/pop%20over/design">popover</a> instead.</p>
</li>
<li class="bullhorn-do-item">
<p><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Don't use when interactions are needed from the user.</novo-text></p>
<p>If the information inside is used to extend a workflow or user interaction, consider using a <a href="#components/modal/design">modal</a> or <a href="#components/pop%20over/design">popover</a> instead.</p>
</li>
<li class="bullhorn-do-item">
<p><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Don't use tooltips to communicate crucial information</novo-text></p>
<p>If you have help text that must be read, consider using a <a href="#components/tip%20well/design">tip well</a> instead.</p>
</li>
<li class="bullhorn-do-item">
<p><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Don't use to display a message based on incorrect action.</novo-text></p>
...
<div class="p"><img src="assets/images/TooltipColor.png" alt="Tooltip Colors"></div>
</blockquote>
<blockquote class="img-last">
<div class="p"><strong>Sizing</strong></div>
...
<div class="p"><img src="assets/images/TooltipSize.png" alt="Tooltip Size"></div>
</blockquote>
<blockquote class="img-last">
<div class="p"><strong>Placement</strong></div>
...
<div class="p"><img src="assets/images/TooltipPosition.png" alt="Tooltip Placement"></div>
</blockquote>
`,
  host: { class: 'markdown-page' }
})
...
<h2>Best Practices</h2>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Limit line length to 70–80 characters.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Paragraph text should be a minimum of 14pt.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Small fonts need more spacing.</novo-text></li>
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Check your line spacing when you change font or font size.</novo-text></li>
</ul>
...
<h3>Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> When you can select multiple items in a picker and you have selected the item.</novo-text></li>
</ul>
</div>
<div>
<h3>Don′t Use When</h3>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> When the user is only allowed to make a single selection from a picker input.</novo-text></li>
</ul>
</div>
</novo-grid>
<h2>Anatomy</h2>
...
<ul class="contains-do-list">
<li class="bullhorn-do-item">
<p><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> When information can be grouped and the user might need access to multiple groups of information at once.</novo-text></p>
<p>TBW</p>
</li>
<li class="bullhorn-do-item">
<p><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> When providing a summary of content as an entry point to a larger grouping of information</novo-text></p>
<p>TBW</p>
</li>
</ul>
</div>
...
<ul class="contains-do-list">
<li class="bullhorn-do-item">
<p><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> When a lot of information on the card makes it too large. Instead consider using a modal or showing the information on a new page.</novo-text></p>
<p>TBW</p>
</li>
</ul>
</div>
...
<ul class="contains-do-list">
<li class="bullhorn-do-item">
<p><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> When a page contains a lot of information that can be clearly grouped and named.</novo-text></p>
<p>E.g. A Candidate record page can be split up into Work History, Credentials, Education, etc.</p>
</li>
<li class="bullhorn-do-item">
<p><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> For top level page navigation</novo-text></p>
...
<ul class="contains-do-list">
<li class="bullhorn-do-item">
<p><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Do not use to separate related content into multiple parts or break up (inter)actions that are important to continue with the user’s workflow.</novo-text></p>
...
<li class="bullhorn-do-item">
<p><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Do not use when the users needs to see the information on each tab at the same time.</novo-text></p>
...
<li class="bullhorn-do-item">
<p><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Do not use to control the view of a single component, instead use radio buttons or tiles (button bar / segmented button).</novo-text></p>
...
<div class="p"><img src="https://via.placeholder.com/350x250" alt="placeholder"></div>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="success" mr="md" size="md">check</novo-icon><novo-text color="success"> Horizontal Tabs</novo-text></li>
</ul>
...
<div class="p"><img src="https://via.placeholder.com/350x250" alt="placeholder"></div>
<ul class="contains-do-list">
<li class="bullhorn-do-item"><novo-icon color="error" mr="md" size="md">times</novo-icon><novo-text color="error"> Vertical Tabs</novo-text></li>
</ul>
<div class="p">TBW...</div>
</blockquote>
</novo-grid>
...
const routes: Routes = [
  ...
  { path: 'components/table', component: TablePage, data: { title: 'Table', section: 'components', tag: 'new' } },
  {

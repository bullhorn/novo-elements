...
describe('Toolbar Demo Page', () => {
    ...
    describe('Basic Toolbar Examples', () => {
        it('should display basic toolbar with title', async () => {
            await verifyPresent(toolbarSelectors.basicToolbar);
        });

        it('should display toolbar with accent styling', async () => {
            await verifyPresent(toolbarSelectors.accentToolbar);
        ...
        it('should display company toolbar with icon and navigation', async () => {
            await verifyPresent(toolbarSelectors.companyToolbar);
        ...
        it('should display company toolbar button', async () => {
            await verifyPresent(toolbarSelectors.companyButton);
        });

        it('should display company toolbar action buttons', async () => {
            await verifyPresent(toolbarSelectors.companyShareAction);
            await verifyPresent(toolbarSelectors.companyPrintAction);
            await verifyPresent(toolbarSelectors.companyCloseAction);
        });

        it('should display navigation toolbar with actions', async () => {
            await scrollIntoView(toolbarSelectors.navigationToolbar);
            await verifyPresent(toolbarSelectors.navigationToolbar);
        ...
        it('should display navigation toolbar logo', async () => {
            await verifyPresent(toolbarSelectors.navLogo);
        });

        it('should display navigation toolbar add action', async () => {
            await verifyPresent(toolbarSelectors.navAddAction);
        ...
        it('should display navigation toolbar search', async () => {
            await verifyPresent(toolbarSelectors.navSearch);
        });

        it('should display navigation toolbar support action', async () => {
            await verifyPresent(toolbarSelectors.navSupportAction);
        ...
        it('should display navigation toolbar settings action', async () => {
            await verifyPresent(toolbarSelectors.navSettingsAction);
        ...
        it('should display navigation toolbar avatar', async () => {
            await verifyPresent(toolbarSelectors.navAvatar);
        });
    });
    ...
    describe('Multi-Row Toolbar Examples', () => {
        it('should display multi-row toolbar', async () => {
            ...
            await verifyPresent(toolbarSelectors.multiRowToolbar);
        });

        it('should display toolbar header row with company color', async () => {
            await verifyPresent(toolbarSelectors.toolbarRowHeader);

    ...
    setupMixedPickerDemo() {
        this.mixedPicker = {
            options: [
                ...
                {value: 'p2', label: 'Option Two - Static Secondary Options', secondaryOptions: [
                    {value: 'p2s1', label: 'Static Secondary Option 1'},
                    {value: 'p2s2', label: 'Static Secondary Option 2'},
                ]},
                {value: 'p3', label: 'Option Three - Async Secondary Options', getSecondaryOptionsAsync: () => {
                ...
                {value: 'p5', label: 'Option Five - Async Secondary Options with Search', showSearchOnSecondaryOptions: true, getSecondaryOptionsAsync: () => {
                    return new Promise((resolve) => {
                        setTimeout(() => {
                            resolve([

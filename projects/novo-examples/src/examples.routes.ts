      ...
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <p>
              <novo-icon color="grass" mr="1rem">check</novo-icon
  ...
  template: `<h2>Usage</h2>
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      <blockquote>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="1rem">check</novo-icon><novo-text color="grass"> Form Slideout</novo-text>
          </li>
        </ul>
        <div class="p">
      ...
      <blockquote>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grapefruit" mr="1rem">times</novo-icon><novo-text color="grapefruit"> Record Preview</novo-text>
          </li>
        </ul>
        <div class="p">
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      ...
      <div>
        ...
        <ul class="contains-do-list">
          ...
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="1rem">check</novo-icon><novo-text color="grass"> Cancelling an action.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="1rem">check</novo-icon><novo-text color="grass"> Resetting a form or dataset.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="1rem">check</novo-icon><novo-text color="grass"> Closing a container or section.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="1rem">check</novo-icon><novo-text color="grass"> Opening a popover.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="1rem">check</novo-icon
          ...
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="1rem">check</novo-icon><novo-text color="grass"> Creating an object within a group.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="1rem">check</novo-icon
  ...
  template: `<novo-grid columns="2" align="start" gap="2rem">
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      <blockquote>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="1rem">check</novo-icon><novo-text color="grass"> Always do this</novo-text>
          </li>
        </ul>
...
@Component({
  ...
  template: `<novo-grid columns="2" align="start" gap="2rem">
      ...
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="1rem">check</novo-icon><novo-text color="grass"> A user must enter text data</novo-text>
          </li>
        </ul>
      </div>
      <div>
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      <div>
        ...
        <ul class="contains-do-list">
          ...
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="1rem">check</novo-icon><novo-text color="grass"> Spacing is limited.</novo-text>
          </li>
        </ul>
      </div>
      <img src="https://via.placeholder.com/350x250" />
  ...
  template: `<h2>Usage</h2>
    <novo-grid columns="2" align="start" gap="2rem">
      ...
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="1rem">check</novo-icon><novo-text color="grass"> Loading content.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="1rem">check</novo-icon><novo-text color="grass"> Processing an long running action.</novo-text>
          </li>
        </ul>
      </div>
      <div>
  ...
  template: `<h2>Usage</h2>
    <novo-grid columns="2" align="start" gap="2rem">
      ...
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grapefruit" mr="1rem">times</novo-icon
            ><novo-text color="grapefruit"> Providing a description longer than 10 words. Instead, use a popover.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grapefruit" mr="1rem">times</novo-icon
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      ...
      <blockquote>
        <div class="p"><strong>Placement</strong></div>
        <div class="p">
          A tooltip is positioned in relation to its target. Placement property values are at the: <code>top</code>, <code>top left</code>,
          <code>top right</code>, <code>bottom</code>, <code>bottom left</code>, <code>bottom right</code>, <code>left</code>,
          <code>right</code>. The default placement value is at the top.
        </div>
      </blockquote>
...
@Component({
  ...
  template: `<h1>Typography</h1>
    ...
    <ul class="contains-do-list">
      <li class="bullhorn-do-item">
        <novo-icon color="grass" mr="1rem">check</novo-icon><novo-text color="grass"> Limit line length to 70–80 characters.</novo-text>
      </li>
      <li class="bullhorn-do-item">
        <novo-icon color="grass" mr="1rem">check</novo-icon
      ...
      <li class="bullhorn-do-item">
        <novo-icon color="grass" mr="1rem">check</novo-icon><novo-text color="grass"> Small fonts need more spacing.</novo-text>
      </li>
      <li class="bullhorn-do-item">
        <novo-icon color="grass" mr="1rem">check</novo-icon
  ...
  template: `<h2>Usage</h2>
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      <blockquote>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="1rem">check</novo-icon><novo-text color="grass"> Horizontal Tabs</novo-text>
          </li>
        </ul>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">form</span>&gt;</span>
    ...
    <p>
      ...
      special shout out to Dan V and Charles
    </p> `,
  host: { class: 'markdown-page' },
})

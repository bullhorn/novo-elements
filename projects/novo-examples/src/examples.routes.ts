...
@Component({
  ...
  template: `<h2>Usage</h2>
    <novo-grid columns="2" align="start" gap="2rem">
      <div>
        Used to help display scheduled events for the day/week/month. The agenda component allow you to display events for any range grouped
        by days. You can provide custom templates to each view to modify how the event is displayed and to add additional content.
      </div>
      ...
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <p>
              <novo-icon color="grass" mr="md" size="md">check</novo-icon
              ><novo-text color="grass"> When representing scheduled events or a history of actions.</novo-text>
            </p>
            <p>
              The Agenda should be used to plot dates or events already tracked in the system and should be used as a way to visualize those
              events.
            </p>
          </li>
        </ul>
      ...
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <p>
              <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon
              ><novo-text color="grapefruit"> Don't use to select a date or range of dates.</novo-text>
            </p>
            <p>
              While the Agenda and events can be interactive it should not be used to select dates. Instead use the <code>calendar</code> or
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      <blockquote>
        ...
        <div class="p">
          Used to present the user with a calendar of scheduled event for a month. The event styles can be overridden with a custom
          template, this allows the implementation to determine how the display should change based on the context of the scheduled event.
        </div>
      </blockquote>
      ...
      <blockquote>
        ...
        <div class="p">
          The agenda's week view component can disply the scheduled events showing the 5-7 days of that week. Unlike the Month View, events
          will be plotted vertically based on the time of day the event starts. Event containers height will only be as tall as the duration
          of the event.
        </div>
      </blockquote>
      <blockquote>
        ...
        <div class="p">
          Similar to the Week View but only display events for a single day. This is helpful when the week view is very congested because
          this allows overlapping events to stack horizontally, allowing for better readability.
        </div>
      </blockquote>
...
@Component({
  ...
  template: `<h2>Usage</h2>
    <novo-grid columns="2" align="start" gap="2rem">
      <div>
        <p>
          Asides are slideouts designed to provide a view into related content within the page without navigating away. Asides work similar
          to Modal but the content is meant to be correlated and the workflow should be non-blocking.
        </p>
      </div>
      ...
      <div>
        ...
        <ul class="contains-do-list">
          ...
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon
            ><novo-text color="grass"> The content provided doesn't block the workflow of the previous context.</novo-text>
          </li>
        </ul>
      </div>
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            ...
            ><novo-text color="grapefruit">
              The content of the aside requires immediate action or response. Instead, use a modal.</novo-text
            >
          </li>
        </ul>
      </div>
    ...
    <ul>
      <li>
        Ensure the content opened is highly correlated to the context that opened it. When showing a preview of a related content that can
        opened for various contexts, present the user with the data related to the context that opened it, rather than the same view.
      </li>
      <li>
        When using an aside to present the user with a form, ensure that it is beneficial to have the current view still available to the
        user, if not consider opening a new page.
      </li>
    </ul>
    <h2>Patterns</h2>
    <novo-grid columns="2" align="start" gap="2rem">
      <blockquote>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon><novo-text color="grass"> Form Slideout</novo-text>
          </li>
        </ul>
        <div class="p">
          Utilize the aside to open quick forms within the application. With the <code>aside</code> you can provide a workflow to enter data
          quickly while still provide a partial view of the parent context. This will allow the user to maintain context and see how the
          addition of new data affects there current view.
        </div>
      </blockquote>
      <blockquote>
        <div class="p"><img src="https://via.placeholder.com/350x250" alt="placeholder" /></div>
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon><novo-text color="grapefruit"> Record Preview</novo-text>
          </li>
        </ul>
        <div class="p">
          Utilize the aside to open record previews within the application. With the <code>aside</code> you can allow the user to view a
          significant amount data about a related entity with losing the context of the current view.
        </div>
      </blockquote>
    </novo-grid>
    <h2>Accessibility</h2>
...
@Component({
  ...
  template: `<h2>Usage</h2>
    <novo-grid columns="2" align="start" gap="2rem">
      <div>
        <p>
          The autocomplete component is designed to provide a list of options as the user types that can be used to set the field value. The
          component can be used to set more complex data to the form. Usually the input does not require a valid option to be selected.
        </p>
      </div>
      ...
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon
            ><novo-text color="grass"> A list of possible values are known but not required.</novo-text>
          </li>
        </ul>
      </div>
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon
            ><novo-text color="grapefruit">
              The form field requires the value to be one of the predefined options. use a select or picker instead.</novo-text
            >
          </li>
        </ul>
      </div>
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      <blockquote>
        ...
        <div class="p">
          A popovers width should match the width of the input it is correlated to a min width of 15rem is set to avoid readability issues.
          The popover have a fixed height and should be scrollable, a persistent scrollbar should be visible if this is the case.
        </div>
      </blockquote>
      <blockquote>
        <div class="p"><strong>Multiple Selections</strong></div>
        <div class="p">
          When the input allows multiple selection the autocomplete popover should add values to the input as a comma-separated list. The
          component can be paired with a chip-list as-well.
        </div>
      </blockquote>
    </novo-grid>
    <h2>Accessibility</h2>
    ...
    <p>
      The user should be able to use the <code>up</code> and <code>own</code> arrows to navigate between options and press
      <code>enter</code> to select the active option.
    </p>
    <p><strong>Implementation</strong></p>
    <p>
      The component should follow the
      <a href="https://www.w3.org/TR/wai-aria-practices/examples/combobox/aria1.1pattern/listbox-combo.html">ARIA combobox interaction</a>
      pattern and have a role of <code>combobox</code>.
    </p> `,
  host: { class: 'markdown-page' },
})
  ...
  template: `<h2>Usage</h2>
    <novo-grid columns="2" align="start" gap="2rem">
      <div>
        ...
        <p>
          An avatar acts as a proxy for a user or entity (such as a company) in a product. They're often combined with status or presence
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      <blockquote>
        ...
        <div class="p">
          Avatars are a great place to attach a menu with options that you can perform against that user. This is a common web paradigm that
          the user will understand intuitively.
        </div>
      </blockquote>
...
@Component({
  ...
  template: `<h2>Usage</h2>
    ...
    <ul class="contains-do-list">
      <li class="bullhorn-do-item">
        <novo-icon color="grass" mr="md" size="md">check</novo-icon
        ><novo-text color="grass"> When the system has more than two layers in a hierarchy.</novo-text>
      </li>
      <li class="bullhorn-do-item">
        <novo-icon color="grass" mr="md" size="md">check</novo-icon
        ><novo-text color="grass"> When you need to inform the user of where they are.</novo-text>
      </li>
      <li class="bullhorn-do-item">
        <novo-icon color="grass" mr="md" size="md">check</novo-icon
        ><novo-text color="grass"> When the user may need to navigate back to a higher level.</novo-text>
      </li>
      <li class="bullhorn-do-item">
        <novo-icon color="grass" mr="md" size="md">check</novo-icon
        ><novo-text color="grass"> When the application has multi-layer architecture.</novo-text>
      </li>
    </ul>
    <h2>Best Practices</h2>
    <ul>
    ...
    <p><strong>Implementation</strong></p>
    <p>
      This component is intended to follow the
      <a href="https://www.w3.org/TR/wai-aria-practices/#breadcrumb">Aria Breadcrumb Design Pattern</a>.
    </p> `,
  host: { class: 'markdown-page' },
})
  ...
  template: `<h2>Usage</h2>
    <novo-grid columns="2" align="start" gap="2rem">
      ...
      <div>
        ...
        <ul class="contains-do-list">
          ...
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon><novo-text color="grass"> Cancelling an action.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon><novo-text color="grass"> Resetting a form or dataset.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon
            ><novo-text color="grass"> Closing a container or section.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon><novo-text color="grass"> Opening a popover.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon
          ...
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon
            ><novo-text color="grass"> Creating an object within a group.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      ...
      <div>
        <ol>
          ...
          <li>
            <p>
              <strong>Text (Optional)</strong><br />
        ...
        <ol>
          <li>
            <p>
              ...
              The basic button is used when a light weight action is needed or when placed within a component that would make the button to
              noisy. ie. When adding an actions button to a table row.
            </p>
          </li>
          <li>
            <p>
              <strong>Primary</strong><br />
              Should be used to draw attention to the user that this is the primary call to action for the current view. eg. Save on an Edit
              Page.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              ...
              Used to provide a equally weighted option that is optional when displayed next to a primary or secondary button. eg. Close
              button for a Modal.
            </p>
          </li>
        </ol>
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      <blockquote>
        ...
        <div class="p">
          Buttons can be configured with an Icon (<code>icon=&quot;check&quot;</code>) with <code>side=&quot;left&quot;</code> or
          <code>side=&quot;right&quot;</code>(default). The context should usually determine the placement of the icon. When the button text
          is a predicate, eg. <strong>Add Candidate</strong>, the <code>bhi-add</code> icon should be a prefix. When the button text is
          imperative, eg . <strong>Save</strong>, then icon should be display as a suffix. Exception may occur.
        </div>
      </blockquote>
      ...
      <blockquote>
        ...
        <div class="p">
          When spacing is limited and an actions meaning can be conveyed with just an icon, it is acceptable to use the <code>icon</code> or
          <code>fab</code> themed buttons. In general icon buttons are used to help provide actions withing complex components, eg. next and
          previous in the <code>novo-calendar</code> or <code>novo-pagination</code> components. The <code>novo-action</code> button is a
          wrapper for icon buttons to show in the <code>novo-header</code> action area.
        </div>
      </blockquote>
    ...
    <p><strong>Implementation</strong></p>
    <p>
      Always include an <code>aria-label</code> or <code>aria-labelledby</code> attribute when using icon buttons. When the button is
      disabled <code>aria-disabled=&quot;true&quot;</code> and <code>tabindex=&quot;-1&quot;</code> should be set automatically by the
      component.
    </p> `,
  host: { class: 'markdown-page' },
})
...
@Component({
  ...
  template: `<h1>Technical Details</h1>
    ...
    <ul class="contains-task-list">
      ...
      <li class="task-list-item">
        <input class="task-list-item-checkbox" checked="" disabled="" type="checkbox" /> Make color and theming consistent
      </li>
      <li class="task-list-item"><input class="task-list-item-checkbox" checked="" disabled="" type="checkbox" /> Dark Mode</li>
      <li class="task-list-item">
        <input class="task-list-item-checkbox" disabled="" type="checkbox" /> Depreacted <code>theme</code> property in favor of
        <code>type</code>
      </li>
    </ul>
    <h1>Changelog</h1>
...
@Component({
  ...
  template: `<h2>Usage</h2>
    <novo-grid columns="2" align="start" gap="2rem">
      <div>
        <p>
          Calendars allow users to easily select dates. It comes in a handful of varieties based on the data the user is trying to enter,
          ie. A Single Date, Date Ranges, or Multiple Dates.
        </p>
        <p>
          The <code>novo-calendar</code> component is used to select a dates in a reactive way to be used in the presentation or filtering
          of data within a view container. The <code>novo-calendar</code> component is not a FormControl itself but is use in the
          <code>novo-date-picker</code> component when selecting dates.
        </p>
      </div>
      ...
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <p>
              <novo-icon color="grass" mr="md" size="md">check</novo-icon
              ><novo-text color="grass"> When the user needs to select a date to control or filter data on the page.</novo-text>
            </p>
            <p>
              The <code>novo-calendar</code> component by itself is just a way to store a date or date range value in the view model. These
              date can be used to manipulate the UI.
            </p>
          </li>
        </ul>
      </div>
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <p>
              <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon
              ><novo-text color="grapefruit"> When you are capturing dates as part of a Form.</novo-text>
            </p>
            <p>
              If you need to store the date(s) in a Form with validation, you should use the <code>date-picker</code> component, which wraps
              the calendar in a FormControl.
            </p>
          </li>
        </ul>
      </div>
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      <blockquote>
        ...
        <div class="p">
          Sometimes dates and ranges are more valueable to see over the multiple months, for this reason the component allows you to show
          consecutive months in the view. The view is responsive and will show the months horizontally first, to have a vertical list just
          set a fixed width on the container.
        </div>
      </blockquote>
      <blockquote>
      ...
      <blockquote>
        ...
        <div class="p">
          Sometimes selecting the by a fixed range of dates, like the week is necessary to ensure the right data is selected. For example,
          when selecting a pay period or work week. Using this selection mode with the appropriate <code>weekStart</code> property to set
...
@Component({
  ...
  template: `<h1>Technical Details</h1>
    <ul>
      <li>
        <strong>source:</strong>
        <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/calendar">(github)</a>
      </li>
    ...
    <typedef-example>
      <typedef-content>
        <novo-calendar [mode]="mode.value" [numberOfMonths]="months.value"></novo-calendar>
      </typedef-content>
      <typedef-specs>
  ...
  template: `<novo-grid columns="2" align="start" gap="2rem">
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      <blockquote>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon><novo-text color="grass"> Always do this</novo-text>
          </li>
        </ul>
      ...
      <blockquote>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon><novo-text color="grapefruit"> Never do this</novo-text>
          </li>
        </ul>
        <div class="p">Explain this</div>
      </blockquote>
  ...
  template: `<novo-grid columns="2" align="start" gap="2rem">
      <div>
        ...
        <p>
          ...
          control&quot; refers to the component that the <code>&lt;novo-field&gt;</code> is wrapping (e.g. the input, textarea, select,
          etc.)
        </p>
      ...
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon><novo-text color="grass"> A user must enter text data</novo-text>
          </li>
        </ul>
      </div>
      <div>
  ...
  template: `<h2>Usage</h2>
    <novo-grid columns="2" align="start" gap="2rem">
      <div>
        ...
        <ul class="contains-do-list">
          ...
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon><novo-text color="grass"> Spacing is limited.</novo-text>
          </li>
        </ul>
      </div>
      <img src="https://via.placeholder.com/350x250" />
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      <blockquote>
        ...
        <div class="p">
          Use color to convey additional meaning when displaying icons. Application colors such as <code>success</code> and
          <code>negative</code> can help express the meaning of the context being used. Entity colors such as <code>job</code> and
          <code>candidate</code> can help the user identify context quickly when parsing large amounts of data.
        </div>
      </blockquote>
      <blockquote>
        <div class="p"><strong>Filled</strong></div>
        <div class="p">
          Icons can have color and optionally you can set the background color to show as well. This creates a visual emphasis on the icon
          and context it is describing. This style can be used when it is important to draw more attention to an item or when it
          asthetically makes sense for the icon to have a heavier presence in the UI.
        </div>
      </blockquote>
    </novo-grid>
    <h2>Accessibility</h2>
  ...
  template: `<h2>Usage</h2>
    <novo-grid columns="2" align="start" gap="2rem">
      ...
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon><novo-text color="grass"> Loading content.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon
            ><novo-text color="grass"> Processing an long running action.</novo-text>
          </li>
        </ul>
      </div>
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon
            ><novo-text color="grapefruit"> When not loading data.</novo-text>
          </li>
        </ul>
      </div>
    </novo-grid>
  ...
  template: `<h2>Usage</h2>
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      ...
      <div>
        <ol>
          ...
          <li>
            <p>
              <strong>SubMenu Indicator</strong><br />
              The element representing the input control: <code>input</code>, <code>select</code>, etc...
            </p>
          </li>
        </ol>
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      <blockquote>
        ...
        <div class="p">
          If not all of the options can be presented within the view, then the menu should be scrollable. To prevent confusion with the user
          that the only options available are those viewable, a persistent scrollbar should be shown.
        </div>
      </blockquote>
      <blockquote>
        ...
        <div class="p">
          The menu should be placed differently based on the context that triggers it. For DropDown Menu the Menu should be placed below the
          button, aligned right or left based on the alignment of the button within its layout. ie. if the button is positioned at the end
          of a header (flex-end) then the right side of the menu should align with the right side of the button.
        </div>
        <div class="p">If there is not enough room below an button it is acceptable for the menu to drop up instead.</div>
      </blockquote>
      <blockquote>
        <div class="p"><img src="assets/images/MenuContext.png" alt="placeholder" /></div>
        <div class="p"><strong>Context Menu</strong></div>
        <div class="p">
          A button is not required to trigger a menu. Any element can be set to trigger a menu on click or right-click. Context Menus can
          provide addition data to be used when displaying the menu. eg. Menu items can be hidden/shown based on the values within that
          context and context can be passed to the click actions.
        </div>
      </blockquote>
      <blockquote>
        ...
        <div class="p">
          <em>Beta</em> When the large variety of options are available to the user, categorize these options to create multiple levels of
          hierarchy.
        </div>
        <div class="p">
          SubMenus are just menus triggered of a menu-item of parent. SubMenus shoudld appear to the right or left of parent list items,
  ...
  template: `<h2>Usage</h2>
    <novo-grid columns="2" align="start" gap="2rem">
      <div>
        ...
        <p>
          Modals are used to inform the user of something critical, force a decision, or extend a series of tasks. There are two categories
          of modals in the system: confirmation and workflow.
        </p>
      </div>
      <img src="https://via.placeholder.com/350x250" />
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            ...
            <p>
              Use a notification modal to ask the user to confirm when performing an irreversible action such as deleting a record,
              navigating away from something unsaved, or converting a file.
            </p>
          </li>
          <li class="bullhorn-do-item">
            <p>
            ...
            <p>
              Use notification modals to make the user aware that their action will affect other records. The modal should ask them to
              confirm this action and explicitly say what the changes to other records will be. (find an example for this - deleting shifts
              could work, sending out bulk emails)
            </p>
          </li>
          <li class="bullhorn-do-item">
            <p>
      ...
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            ...
            <p>
              Don’t use a notification modal to confirm an action that has already been completed. Conveying information that does not
              require action is not critical enough to fully obscure the main content of the page. Use a
          ...
          <li class="bullhorn-do-item">
            ...
            <p>
              Don’t obscure the main content of the screen for a task that is not directly related to the subject matter of that screen.
              Open a new page or use a <a href="/components/aside">slideout</a> instead.
            </p>
          </li>
        </ul>
      </div>
  ...
  template: `<h2>Usage</h2>
    <novo-grid columns="2" align="start" gap="2rem">
      <div>
        ...
        <ul>
          <li>
            <strong>Empty state</strong>: when a list has no data in it yet, or a container's contents have been intentionally removed.
          </li>
          <li>
          ...
          <li>
            <strong>Error state</strong>: its broken (for instance, 404 and 500 HTTP errors). In this case, best practice is to add a call
            to action directing the user what to do next.
          </li>
        </ul>
      </div>
      <img src="https://via.placeholder.com/350x250" />
      ...
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon><novo-text color="grapefruit"> tbw</novo-text>
          </li>
        </ul>
      </div>
    </novo-grid>
...
@Component({
  ...
  template: `<h1>Technical Details</h1>
    <ul>
      <li>
        <strong>source:</strong>
        <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/non-ideal-state">(github)</a>
      </li>
...
@Component({
  ...
  template: `<h2>Usage</h2>
    <novo-grid columns="2" align="start" gap="2rem">
      <div>
        <p>
          Popovers are layered containers that hold additional information or controls. Popovers are containers used to display transient
          content such as menus, options, additional actions, and more. They visually stand out through stroke and drop shadow and float on
      ...
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon
            ><novo-text color="grass"> Displaying supplementary content or actions, without obscuring the page.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon
            ><novo-text color="grass"> Creating a menu by placing a list group inside of a popover.</novo-text>
          </li>
        </ul>
      </div>
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon
            ><novo-text color="grapefruit"> When content is 10 words or fewer. Instead, use a tooltip.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon
            ><novo-text color="grapefruit">
              Requiring a user to complete a complex task. Instead, use a modal or a separate page.</novo-text
            >
          </li>
        </ul>
      </div>
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      <blockquote>
        ...
        <div class="p">
          By default, popovers have a pointers. Popovers without a pointer should be used when the trigger has a visually distinctive
          selected state, in order to show the connection between the popover and its trigger.
        </div>
        <div class="p">
          Most Popovers should have a pointer which should be used to help show the connection to the trigger, in cases where the trigger is
      ...
      <blockquote>
        ...
        <div class="p">
          A popover is positioned in relation to its source. The placement property values are the following: top, top left, top right, top
          start, top end, bottom, bottom left, bottom right, bottom start, bottom end, left, left top, left bottom, start, start top, start
          bottom, right, right top, right bottom, end, end top, end bottom. The default placement value is at the top.
        </div>
      </blockquote>
    </novo-grid>
    <h2>Accessibility</h2>
    <p><strong>Implementation</strong></p>
    <p>
      the popover should follow the Aria <code>complementary</code> role
      <a href="https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Roles/complementary_role">guidelines</a>.
    </p> `,
  host: { class: 'markdown-page' },
})
...
@Component({
  ...
  template: `<h1>Technical Details</h1>
    <p>
      Tooltips are used as system notifications. They can contain custom text titles and messages, as well as any icons from bh-icons and
      any color from our color palletes.
    </p>
    <ul>
      <li>
        <strong>source:</strong>
        <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/tooltips">(github)</a>
      </li>
      <li><strong>module:</strong> <code>import &#123; NovoFieldModule &#125; from 'novo-elements';</code></li>
    </ul>
    <p><strong>Usage</strong></p>
...
@Component({
  ...
  template: `<novo-grid columns="2" align="start" gap="2rem">
    ...
    <div>
      ...
      <ul class="contains-do-list">
        <li class="bullhorn-do-item">
          <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon><novo-text color="grapefruit"> Loading content.</novo-text>
        </li>
        <li class="bullhorn-do-item">
          <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon
...
@Component({
  ...
  template: `<h2>Usage</h2>
    <novo-grid columns="2" align="start" gap="2rem">
      <div>
        <p>
          The TipWell is a small container for displaying help text. It is meant to be shown only once and dismissable to the user. Typical
          usage is to provide additional detail on data being displayed or explain how a feature works to the user for their first time
          using it.
        </p>
      </div>
      ...
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon
            ><novo-text color="grass"> The help text is no longer needed after the user has read the contents.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon
            ><novo-text color="grass">
              To provide additional context and links related to the data to educate the user on how the a feature works.</novo-text
            >
          </li>
        </ul>
      </div>
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon
            ><novo-text color="grapefruit"> Don’t use it show error states, use novo-error or a banner.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon
            ><novo-text color="grapefruit"> Don’t use it to display tutorials.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon
            ><novo-text color="grapefruit"> Don’t use it to explain text fields, use novo-hint.</novo-text>
          </li>
        </ul>
      </div>
    </novo-grid>
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      ...
      <div>
        <ol>
          ...
          <li>
            <p>
              <strong>Dismiss Action</strong><br />
...
@Component({
  ...
  template: `<h1>Technical Details</h1>
    <p>
      Tip Wells are used as ephemeral containers of helpful text. The importance of the content is usually short-lived and no longer needed
      once disseminated.
    </p>
    <ul>
      <li>
        <strong>source:</strong>
        <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/tip-well">(github)</a>
      </li>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">novo-tip-well</span>&gt;</span>
    ...
    <ul class="contains-task-list">
      ...
      <li class="task-list-item"><input class="task-list-item-checkbox" checked="" disabled="" type="checkbox" /> Dark Mode</li>
      <li class="task-list-item">
        <input class="task-list-item-checkbox" disabled="" type="checkbox" /> Create a Provider for TipWell states
      </li>
    </ul>
    <h1>Changelog</h1>
    <h3>6.0.0</h3>
    ...
    <p>
      The <code>novo-tip-well</code> component expects a <code>name</code> property, which will be used to store the state of the tipwell in
      local-storage.
    </p>
    <h3>Properties</h3>
  ...
  template: `<h2>Usage</h2>
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      ...
      <blockquote>
        <div class="p"><strong>Position</strong></div>
        <div class="p">
          Growl notifications can be displayed at the top, left, right, bottom or corner of the page. Notification will also stack on top of
          each other until dismissed. In general that an application use the same location for all growl notications, so the user will know
      ...
      <blockquote>
        ...
        <div class="p">
          Growls and Banners can have actions that can be invoked before being dismissed. This action should be contextual to the action
          that triggered the toast in the first place. eg. Actions like &quot;Undo&quot; or &quot;See more&quot; are common use-case, this
          helps create a workflow that is streamlined for the user but provides optional actions when needed.
        </div>
      </blockquote>
...
@Component({
  ...
  template: `<h2>Usage</h2>
    <novo-grid columns="2" align="start" gap="2rem">
      <div>
        <p>
          Toolbars are containers attached to the top or bottom of a page that contain actions and/or navigation. Toolbars can stack on-top
          of each providing varying levels of content. Toolbars usually act as headers or footers of the page.
        </p>
      </div>
      ...
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon
            ><novo-text color="grass"> The page needs navigation to its various sections.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon
            ><novo-text color="grass"> The page needs to set the context of the page (ie. header with title)</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon
            ><novo-text color="grass"> Global Actions, preferences, setting, filters need to be displayed.</novo-text>
          </li>
        </ul>
      </div>
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon
            ><novo-text color="grapefruit"> Don't use to divide/separate content.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon
            ><novo-text color="grapefruit"> Don’t use it to display multi-line text content.</novo-text>
          </li>
          <li class="bullhorn-do-item">
            <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon
            ><novo-text color="grapefruit"> Don't use it for background color only.</novo-text>
          </li>
        </ul>
      </div>
    </novo-grid>
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      <blockquote>
        ...
        <div class="p">
          A toolbar container can be <code>sm</code>, <code>md</code>, or <code>lg</code>, which can be set by the
          <code>size</code> property. This will affect the height and horizontal padding of the container. Toolbars should all be the same
          size or stacked in descending sizes.
        </div>
      </blockquote>
      <blockquote>
        <div class="p"><img src="https://via.placeholder.com/350x200" alt="placeholder" /></div>
        ...
        <div class="p">
          Use <code>&lt;novo-divider vertical&gt;</code> to separate section in a toolbar row. Divider can be used to separate stacked
          toolbars but only when the toolbars are the same color.
        </div>
      </blockquote>
      <blockquote>
        <div class="p"><img src="https://via.placeholder.com/350x200" alt="placeholder" /></div>
        ...
        <div class="p">
          Branding in general should be setup on the left side of the toolbar. Your toolbar should either have a title or branding but not
          both.
        </div>
      </blockquote>
      <blockquote>
        ...
        <div class="p">
          If you page has side navigation or a menu, than a menu icon can appear before the title or branding. If the toolbar doesn't need
          the <code>menu</code> icon, you may use and static icon to help add context to your title, but you should never have both.
        </div>
      </blockquote>
      <blockquote>
        <div class="p"><img src="https://via.placeholder.com/350x200" alt="placeholder" /></div>
...
@Component({
  ...
  template: `<h1>Technical Details</h1>
    <p>
      Toolbars are used as ephemeral containers of helpful text. The importance of the content is usually short-lived and no longer needed
      once disseminated.
    </p>
    <ul>
      <li>
        <strong>source:</strong>
        <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/toolbar">(github)</a>
      </li>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">novo-toolbar</span>&gt;</span>
    ...
    <p>
      The <code>novo-toolbar-row</code> component is also just a container to help create multi-row toolbars, look at examples to determine
      correct usage.
    </p>
    <h3>Properties</h3>
...
@Component({
  ...
  template: `<h2>Usage</h2>
    <novo-grid columns="2" align="start" gap="2rem">
      <div>
        <p>
          Tooltips are layered containers that provide basic identifying information about an elment. The are usually triggered by hovering
          over the buttons and icons. Tooltips are meant to stand out visually through their contrasting container color to draw immediate
      ...
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <p>
              <novo-icon color="grass" mr="md" size="md">check</novo-icon
              ><novo-text color="grass"> Providing a short description of a page element or control.</novo-text>
            </p>
          ...
          <li class="bullhorn-do-item">
            <p>
              <novo-icon color="grass" mr="md" size="md">check</novo-icon
              ><novo-text color="grass"> Describing the action of an icon-only button.</novo-text>
            </p>
          ...
          <li class="bullhorn-do-item">
            <p>
              <novo-icon color="grass" mr="md" size="md">check</novo-icon
              ><novo-text color="grass"> Revealing the full text of truncated data.</novo-text>
            </p>
      ...
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <p>
              <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon
              ><novo-text color="grapefruit"> Don't use for describing supplemental information.</novo-text>
            </p>
          ...
          <li class="bullhorn-do-item">
            <p>
              <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon
              ><novo-text color="grapefruit"> Don't use when interactions are needed from the user.</novo-text>
            </p>
            <p>
              If the information inside is used to exend a workflow or user interaction, consider using a
              <a href="#components/modal/design">modal</a> or <a href="#components/pop%20over/design">popover</a> instead.
            </p>
          </li>
          <li class="bullhorn-do-item">
            <p>
              <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon
              ><novo-text color="grapefruit"> Don't use tooltips to communicate crucial information</novo-text>
            </p>
          ...
          <li class="bullhorn-do-item">
            <p>
              <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon
              ><novo-text color="grapefruit"> Don't use to display a message based on incorrect action.</novo-text>
            </p>
      ...
      <div>
        <ol>
          <li>
            <p>
              <strong>Container</strong><br />
              Contains the entire body of the tooltip. This container will be positioned based on the aligment of the trigger element. The
              container should appear elevated with a shadow to separate it form the page. The height depends on the number of lines and the
              width is decided contextually based on when it looks best for the tooltip to split into another line.
            </p>
          </li>
          <li>
            <p>
    ...
    <ul>
      ...
      <li>
        When choosing which tooltip position to use, try not to block important content, and make sure that the tooltip is still on the
        screen and readable.
      </li>
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      <blockquote>
        ...
        <div class="p">
          Tooltips also come in semantic variants: informative (blue), positive (green), and negative (red). These use semantic colors to
      ...
      <blockquote>
        <div class="p"><strong>Sizing</strong></div>
        <div class="p">
          When the label is too long for the available horizontal space, it wraps to form another line. To control the visually display
          text-length you can set the size of the tooltip with the <code>tooltip-size</code> property.
        </div>
      </blockquote>
      ...
      <blockquote>
        <div class="p"><strong>Placement</strong></div>
        <div class="p">
          A tooltip is positioned in relation to its source. The placement property values are at the: <code>top</code>,
          <code>top left</code>, <code>top right</code>, <code>bottom</code>, <code>bottom left</code>, <code>bottom right</code>,
          <code>left</code>, <code>right</code>. The default placement value is at the right.
        </div>
      </blockquote>
...
@Component({
  ...
  template: `<h1>Technical Details</h1>
    ...
    <ul>
      <li>
        <strong>source:</strong>
        <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/tooltip">(github)</a>
      </li>
  ...
  template: `<h1>Composition</h1>
    ...
    <blockquote>
      ...
      <div class="p">
        ...
        hierarchy. This is important because it helps to easily differentiate the level of importance between different elements, and
        controls a user's cognitive flow.
      </div>
    </blockquote>
    <novo-grid columns="2" align="start" gap="2rem">
      <blockquote>
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      ...
      <blockquote>
        ...
        <div class="p">
          List headers contain the filter and column controls for the list and the primary actions. They are fixed so that results can eaily
          be modified and actioned regardless of scrolling position.
        </div>
      </blockquote>
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      <blockquote>
        ...
        <div class="p">
          Cards have a header which contains the card title and the card controls. The controls can vary depending on card type, gut
          generally include move, refresh, configure, and remove. The content area has padding by default but can also run edge-to-edge.
          Pulse cards have a special icon next to the title.
        </div>
      </blockquote>
      ...
      <blockquote>
        ...
        <div class="p">
          Dashboards and Records Overviews are the primary home for our cards. They offer a customizable workspace to arrange and configure
          to most appropriately fit the user's needs. Cards have a fixed height, but mildly flexible width. They can also be expanded to
  ...
  template: `<h1>Typography</h1>
    <novo-grid columns="200px 1fr" align="start" gap="2rem">
      ...
      <blockquote>
        ...
        <div class="p">
          Bullhorn's Branding uses the Gotham font family, this is not a free font. With that in mind we build novo-elements to work with
          both the Gotham font and Monteserrat which is a very similar font face available on Google Fonts. Both fonts provide a characters
          that are clean and easy to read with good weight when the font-size is small.
        </div>
    ...
    <ul class="contains-do-list">
      <li class="bullhorn-do-item">
        <novo-icon color="grass" mr="md" size="md">check</novo-icon
        ><novo-text color="grass"> Limit line length to 70–80 characters.</novo-text>
      </li>
      <li class="bullhorn-do-item">
        <novo-icon color="grass" mr="md" size="md">check</novo-icon
        ><novo-text color="grass"> Paragraph text should be a minimum of 14pt.</novo-text>
      </li>
      <li class="bullhorn-do-item">
        <novo-icon color="grass" mr="md" size="md">check</novo-icon><novo-text color="grass"> Small fonts need more spacing.</novo-text>
      </li>
      <li class="bullhorn-do-item">
        <novo-icon color="grass" mr="md" size="md">check</novo-icon
        ><novo-text color="grass"> Check your line spacing when you change font or font size.</novo-text>
      </li>
    </ul>
    ...
    <typedef-example>
      ...
      <typedef-snippet>
        ...
        <code class="tc-negative">@include novo-body-text()</code>
      </typedef-snippet>
    </typedef-example>
    ...
    <p>
      ...
      to as much as possible. Most text components can be adjusted by setting the <code>size</code>, <code>length</code>,
      <code>weight</code>, or <code>color</code> attributes, these values are all theme aware based on novo design tokens.
    </p>
    <h2>Body Text</h2>
    <p>
    ...
    <p>
      ...
      Condensed Thin and Condensed Light. All titles use a line height of 1.375 relative to the font size.
    </p>
    <p>
    ...
    <typedef-example>
      ...
      <typedef-snippet>
        ...
        <code class="tc-negative">@include novo-title-text()</code>
      </typedef-snippet>
    </typedef-example>
    <typedef-example>
      <typedef-content>
        <novo-title [size]="size.value"> Creating an incredible customer experience </novo-title>
      </typedef-content>
      <typedef-specs>
...
@Component({
  ...
  template: `<h2>Usage</h2>
    <novo-grid columns="2" align="start" gap="2rem">
      <div>
        <p>
          Chips show the user that a view or component represents data from multiple contexts. They can present as keywords, people or
          selected values, whether as an form input or filter criteria.
        </p>
      </div>
      ...
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon
            ><novo-text color="grass"> When you can select multiple items in a picker and you have selected the item.</novo-text>
          </li>
        </ul>
      </div>
      <div>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon
            ><novo-text color="grapefruit"> When the user is only allowed to make a single selection from a picker input.</novo-text>
          </li>
        </ul>
      </div>
    </novo-grid>
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      ...
      <div>
        <ol>
          ...
          <li>
            <p>
              <strong>Remove Button (Optional)</strong><br />
          ...
          <li>
            <p>
              <strong>Indicator/Avatar/Icon</strong><br />
              To convey additional context to the user about the type of content, use the Chip Indicator. ie, This should be set to the
              contact icon and color when displaying contact data vs the candidate icon and color when the Chip represents a selected
              candidate
            </p>
          </li>
          <li>
            <p>
              <strong>Preview (optional)</strong><br />
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      <blockquote>
        ...
        <div class="p">
          When the chip text is too long for the available horizontal space, it truncates. The full text should be revealed with a tooltip
          on hover.
        </div>
      </blockquote>
      <blockquote>
...
@Component({
  ...
  template: `<h1>Technical Details</h1>
    <ul>
      <li>
        <strong>source:</strong>
        <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/chips">(github)</a>
      </li>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">novo-chip-list</span>&gt;</span>
    ...
    <h3>6.0.0</h3>
    <p>
      Chips are now separated into their atomic parts: <code>novo-chip</code>, <code>novo-chip-list</code>, <code>novo-chip-input</code>.
    </p>
    <h1>Components</h1>
    <h2>NovoChipElement <code>novo-chip</code></h2>
    <p>
      The <code>novo-chip</code> component is the lowest level component for the chips module. Contains all the styles contained with a
      single chip. This component can start being used for more use-cases other than the multi-select picker.
    </p>
    <h3>Properties</h3>
    <p><props-table component="NovoChipElement"></props-table></p>
    <h2>NovoChipListElement <code>novo-chip-list</code></h2>
    <p>
      The <code>novo-chip-list</code> is just a container to wrap many chips within. This should control basic flow and layout of the
      contained chips.
    </p>
    <h3>Properties</h3>
...
@Component({
  ...
  template: `<h2>Usage</h2>
    ...
    <ul>
      <li>
        Use when a single date selection is required from the user, especially when additional context is around the date selection is
        needed. e.g. selecting a date within a specific date range.
      </li>
...
@Component({
  ...
  template: `<h2>Usage</h2>
    <novo-grid columns="2" align="start" gap="2rem">
      <div>
        <p>
          Date Time Pickers allow users to easily select a time and date. It comes in a handful of varieties based on the content of the
          field.
        </p>
      </div>
  ...
  template: `<h1>Novo Elements, Bullhorn's design system</h1>
    ...
    <novo-grid columns="3" align="start" gap="2rem">
      <blockquote>
        ...
        <div class="p">
          Elegance in utility helps to create a system for humans, not robots. We strive not just to empower users but to delight them in
          the process.
        </div>
      </blockquote>
      <blockquote>
        ...
        <div class="p">
          Vast data reservoirs need a finely tuned system to surface the critical information right when it is needed, no matter the scale
          or setting.
        </div>
      </blockquote>
      <blockquote>
...
ng add novo-elements
    ...
    <p>
      You need to import the <code>NovoButtonModule</code> for the component to display, add the following lines to your
      <code>app.module.ts</code> file.
    </p>
...
@Component({
  ...
  template: `<h2>Usage</h2>
    <novo-grid columns="2" align="start" gap="2rem">
      <div>
        <p>
          Tabs make it easy to explore and switch between different views or functional aspects of an app or to browse categorized data
          sets. Tabs are used to section information over multiple pages within the same context. Only a single tab can be open at a time,
          allowing the user to focus on the information that the tab contains.
        </p>
      </div>
      <img src="assets/images/ButtonOverview.png" />
      <div>
        ...
        <ul class="contains-do-list">
          ...
          <li class="bullhorn-do-item">
            <p>
              <novo-icon color="grass" mr="md" size="md">check</novo-icon
              ><novo-text color="grass"> For top level page navigation</novo-text>
            </p>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <p>
              <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon
              ><novo-text color="grapefruit">
                Do not use to separate related content into multiple parts or break up (inter)actions that are important to continue with
                the user’s workflow.</novo-text
              >
            </p>
            <p>
          ...
          <li class="bullhorn-do-item">
            <p>
              <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon
              ><novo-text color="grapefruit">
                Do not use when the users needs to see the information on each tab at the same time.</novo-text
              >
            </p>
            <p>
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      <blockquote>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grass" mr="md" size="md">check</novo-icon><novo-text color="grass"> Horizontal Tabs</novo-text>
          </li>
        </ul>
      ...
      <blockquote>
        ...
        <ul class="contains-do-list">
          <li class="bullhorn-do-item">
            <novo-icon color="grapefruit" mr="md" size="md">times</novo-icon><novo-text color="grapefruit"> Vertical Tabs</novo-text>
          </li>
        </ul>
        <div class="p">TBW...</div>
      </blockquote>
...
@Component({
  ...
  template: `<h1>🚀 February 2022 (version 6 - Golden)</h1>
    <p>
      <strong>Release v6.0.0</strong>: This release contains several component updates and additional new components. Initial refactoring of
      component architecture to support future efforts to improve the design systems consistency along with improvements to the developer
      experience.
    </p>
    <p>
      Note: This update is a major release which includes changes that require updates to your code. When updating to Novo Elements V6 from
      prior versions, the following commands are required:
    </p>
...
<span class="hljs-attribute">ng</span> update novo-elements --migrate-only --from=<span class="hljs-number">0</span>.<span class="hljs-number">0</span>.<span class="hljs-number">0</span> --to=<span class="hljs-number">6</span>.<span class="hljs-number">0</span>.<span class="hljs-number">0</span> --force --<span class="hljs-literal">allow</span>-dirty  
    ...
    <p>
      For any issues that are not corrected with the above command, please ask questions in the
      <a href="https://github.com/bullhorn/novo-elements/discussions/categories/q-a">Q&amp;A Page</a> in github.
    </p>
    <p>
      Welcome to the February 2022 release of Novo Elements. There are many updates in this version that we hope you will like, some of the
      key highlights include:
    </p>
    <ul>
      <li>
        <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#dev-principle">Development Principle</a> - Philosophy on why we
        are making these changes.
      </li>
      <li>
        <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#improved-docs">Improved Documentation</a> - Check out the new
        Design &amp; Developer Guideline.
      </li>
      <li>
        <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#design-tokens">Design Token &amp; Themes</a> - The Bullhorn
        brand has evolved and the design system.
      </li>
      <li>
        <strong>New Components</strong>
        <ul>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#aside">Aside</a> - A replacement implementation for Preview
            slideouts, that is easy to use and works like modals.
          </li>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#autocomplete">Autocomplete</a> - Low-level feature to help
            composability of custom pickers.
          </li>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#avatar">Avatar</a> - Display user and entity images with
            fallback display.
          </li>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#breadcrumbs">Breadcrumbs</a> - Show nested navigation
            hierarchy.
          </li>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#menu">Menu</a> - Coalesce options into floating overlay with
            a myriad of trigger functionality.
          </li>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#layouts">Layout</a> - Easy to setup layouts with side
            navigation.
          </li>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#color-picker">Color Picker</a> - Pick a color, works with
            form inputs.
          </li>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#toolbar">Toolbar</a> - More flexible toolbar control, to use
            for page headers or navigation.
          </li>
        </ul>
      </li>
      <li>
        ...
        <ul>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#calendar">Calendar</a> - Support for multi-day selection,
            multi-month view, and can now be used independant of the data picker.
          </li>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#modals">Modal</a> - New animation and more events to better
            control Modals.
          </li>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#chips">Chips</a> - Still a WIP, but Chip, ChipList and
            ChipInput are now independant components that can be composed together separately.
          </li>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#select">Select &amp; Dropdown</a> - Overhaul of these
            component to consolidate functionality into the new <code>novo-option</code> component, to create a more declarative design.
          </li>
        </ul>
      </li>
      <li>
        <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#preview-features">Preview Features</a> - Check some new features
        that are still in development.
      </li>
      <li>
        <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#notable-changes">Notable Changes</a> - We changed some things,
        we fixed some things, hopefully left everything better than before!
      </li>
    </ul>
    <blockquote>
      <div class="p">
        If you'd like to read these release notes online, go to <a href="https://bullhorn.github.io/novo-elements/updates">Updates</a> on
        <a href="https://bullhorn.github.io/novo-elements">bullhorn.github.io/novo-elements</a>.
      </div>
    </blockquote>
    <p>
      <strong>Notice</strong>: Want to try new features as soon as possible? You can always view the <code>upcoming</code> relase
      documentation for the <a href="https://bullhorn.github.io/novo-elements">Next Branch</a>. The code is available on
      <a href="https://github.com/bullhorn/novo-elements/tree/next">Github</a> follow the guides to build and try the latest updates as soon
      as they are available.
    </p>
    <h2 id="dev-principle">
      Development Principles <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#dev-principle">#</a>
    </h2>
    <p>
      The overall philosophy for the changes and improvement for the design system stems from the core principle of making each component
      more declarative vs imperative. To illustrate this with an example:
    </p>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">novo-select</span>&gt;</span>
    ...
    <p>
      While the <strong>New and Shiny Way</strong> might seem verbose, it actually creates infinite flexibility within the implementation.
      When the developer is composing features within their application, the component will support things like adding icons on the left and
      right, displaying two rows of info in the options, alternatively before in our imperative design the design system would have to have
      be augmented to support subtle new variants.
    </p>
    <h2 id="improved-documentation">
      Improved Documentation <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#improved-documentation">#</a>
    </h2>
    <p>
      The number one complaint we heard about the design system was that the documentation was sparse and not helpful. With the help of the
      UX teams we have Audited more than half of the components in the design system and added guidelines on the appropiate usage. Developer
      docs with implementation and api details as well as an improvement to the Examples.
    </p>
    <p><img src="assets/images/updates/v6/v6-improved-docs.gif" alt="Design Guideline &amp; Best Practices" width="640px" /></p>
    <h2 id="design-tokens">
      Design Token &amp; Themes <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#design-tokens">#</a>
    </h2>
    <p>
      A significant milestone was reached in v6 which is to create a
      <a href="https://github.com/amzn/style-dictionary">Style Dictionary</a> to isolate our variables into a
      <a href="https://github.com/bullhorn/novo-design-tokens">design tokens library</a>. A Style Dictionary uses design tokens to define
      styles once and use those styles on any platform or language. This will allow the novo design system to help us create a coheosive
      look and feel across all our product suites regardless of the technologies being used. It also helps create better structure of our
      variables and tokens to ensure ease of use.
    </p>
    ...
    <p>
      Asides are slideouts designed to provide a view into related content within the page without navigating away. Asides work similar to
      Modal but the content is meant to be correlated and the workflow should be non-blocking.
    </p>
    ...
    <p>
      This is a series of components that introduce the ability to configure your application layout, we introduce the a new side navigation
      panel that can dock on the left or right or hide and collapse to make a more responsive application.
    </p>
    ...
    <p>
      Toolbars are containers attached to the top or bottom of a page that contain actions and/or navigation. Toolbars can stack on-top of
      each providing varying levels of content. Toolbars usually act as headers or footers of the page.
    </p>
    ...
    <h2 id="updated-components">
      Updated Components <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#updated-components">#</a>
    </h2>
    <h3 id="calendar">Calendar <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#calendar">#</a></h3>
    <p>
      The calendar has been refactored into smaller components to allow for a cleaner implementation when composing for the datepicker.
      Support for multi-day selection and multi-month view have been added. see new props below:
    </p>
    <table>
      <thead>
        <tr>
    ...
    <p>
      There are two objects injected into the Modal <code>NovoModalRef</code> and <code>NovoModalParams</code>. Typing support for the
      NovoModalParams is difficult. You no longer need to do this you only need the single reference to <code>NovoModalRef</code> which now
      accepts a generic. <code>ref:NovoModalRef&lt;DeleteModalParams&gt;</code> will now type the <code>ref.params</code>.
    </p>
    <p>
      <code>NovoModalRef</code> used to only have the <code>onClosed</code> which returns a promise with and value returned from the Modal
      to the calling component. We have added two new observables for <code>beforeClose</code> and <code>afterClosed</code> in order to
    </p>
    ...
    <p>
      This milestone, we introduce the Side Panel, a new surface in the workbench opposite the Side Bar, where you can house views from the
      Side Bar or the bottom Panel. Unlike moving the bottom Panel to the left or the right of the editor, the new Side Panel works in
      addition to the bottom Panel so you can see more sets of views at once.
    </p>
    ...
    <p>
      We already talked about the change from imperative to declarative. We have consolidated all of our display of option/menu-items used
      by many components into a single implmenation of <code>novo-option</code> and groupings with <code>novo-optgroup</code>. Several new
      patterns for searching within optgroups are works in progress, but coming soon. The major change is how to migrate
      <code>novo-dropdown</code> contents to the new implementation.
    </p>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">novo-dropdown</span>&gt;</span>
    ...
    <h2 id="preview-features">
      Preview Features <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#preview-features">#</a>
    </h2>
    <h3 id="utility-directives">
      Utility Directives <a href="https://bullhorn.github.io/novo-elements/docs/#/updates/v6#utility-directives">#</a>
    </h3>
    <p>
      Composing layouts is difficult especially when you need to create css classes for all your container. It gets very repetitive add
      <code>display: flex</code> and <code>flex-direction: row</code>. Now we have new utility components and directive to compose the
      general layout of a page without writing any css. The goal is reduce application specific css to zero. Here are the new features we
      have added to support this.
    </p>
    <ul>
    ...
    <p>
      In addition to these layout components you can add directives (attributes) to any element on your page. All of these elements are
      <strong>theme aware</strong> as in they will look up the value from the design token library and use that value.
    </p>
    <table>
      <thead>
        <tr>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">novo-flex</span>&gt;</span>
    ...
    <p>
      A new experimental <code>novo-field</code> component has been added to help improve the future of <code>novo-form</code> (which it is
      not currently using). The <code>novo-field</code> and its supporting cast of components and directives makes it really easy to compose
      static forms.
    </p>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">form</span>&gt;</span>
    ...
    <ul>
      ...
      <li>
        <code>list</code> and <code>item</code> are not valid web-component or angular standard tags. use <code>novo-list</code> and
        <code>novo-list-item</code>, but use <code>novo-option</code> and <code>novo-optgroup</code> inside of a dropdown.
      </li>
      <li>
        <code>list</code> and <code>item</code> are not valid web-component or angular standard tags. use <code>novo-list</code> and
        <code>novo-list-item</code>, but use <code>novo-option</code> and <code>novo-optgroup</code> inside of a dropdown.
    ...
    <p>
      Last but certainly not least, a big <em>Thank You</em> to the contributors of Novo Elements throughout the years. For this release a
      special shout out to our developers Dan Voegelin and Charles Barnes, the automation team for helping us test the changes: Jon Eman,
      Tiffany Bertolozzi, Tony Phu and Ashley Schroeder, and our UX Team include but not limited to: Jon Braun, Madeliene Valcour, Katie
      Todd, Daniel Long, Angela Wang and Gloria Nam.
    </p> `,
  host: { class: 'markdown-page' },
})
...
@Component({
  ...
  template: `<h1>Field Interactions</h1>
    ...
    <p>
      Lastly, 'invokeOnInit' will also trigger the Field Interaction when the form is created as well. A script can check
      <code>API.isInvokedOnInit</code> to determine if the current call is due to initialization or due to a user change.
    </p>
    ...
    <p>
      Field Interactions can navigate nested forms to interact with parent and child forms. This example uses the Form Group component which
      contains an array of nested forms that are kept in sync by field interactions.
    </p>
...
const routes: Routes = [
  ...
  { path: 'form-controls/value', component: ValuePage, data: { title: 'Value', section: 'form-controls' } },
  {
    ...
    data: {
      ...
      description: CardDescriptionPage,
    },
    children: [

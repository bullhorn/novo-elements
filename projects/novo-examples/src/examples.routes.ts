...
@Component({
  ...
  template: `
    ...
    <p>
      The <a href="https://github.com/bullhorn/extension-samples">Bullhorn Extension Samples</a> repoprovides several examples for getting
...
@Component({
  ...
  template: `
    ...
    <p>NEW!!!!</p>
    <p><code-example example="all-custom-modal"></code-example></p>

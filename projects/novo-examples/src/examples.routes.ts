...
@Component({
  ...
  template: `
    <h1>Button <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/button">(source)</a></h1>
    <p>
...
@Component({
  ...
  template: `
    <h1>
      Dropdown <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/dropdown">(source)</a>
    </h1>
...
@Component({
  selector: 'icon-page',
  template: `
    <h1>Icons <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/icon">(source)</a></h1>
    <p>
...
@Component({
  ...
  template: `
    <h1>
      Loading Animations
      <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/loading">(source)</a>
    </h1>
    <p>
...
@Component({
  selector: 'table-page',
  template: `
    <h1>Table <a href="https://bullhorn.github.io/novo-elements/tree/master/projects/novo-examples/src/elements/table">(source)</a></h1>
    <p>
...
@Component({
  selector: 'chips-page',
  template: `
    <h1>Chips <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/chips">(source)</a></h1>
    <p>
...
@Component({
  ...
  template: `
    ...
    <h5>Custom Config Example</h5>
    <p><code-example example="custom-editor"></code-example></p>
  `,
})
...
@Component({
  selector: 'form-page',
  template: `
    <h1>Forms <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/form">(source)</a></h1>
    <p>
...
@Component({
  ...
  template: `
    <h1>Picker <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/picker">(source)</a></h1>
    <p>
...
@Component({
  ...
  template: `
    <h1>Radio <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/radio">(source)</a></h1>
    <p>A radio group</p>
    <h5>Basic</h5>
...
@Component({
  ...
  template: `
    <h1>Select <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/select">(source)</a></h1>
    <p>
...
@Component({
  selector: 'tiles-page',
  template: `
    <h1>Tiles <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/tiles">(source)</a></h1>
...
@Component({
  selector: 'cards-page',
  template: `
    <h1>Cards <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/card">(source)</a></h1>
...
@Component({
  ...
  template: `
    <h1>Headers <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/header">(source)</a></h1>
...
@Component({
  selector: 'tabs-page',
  template: `
    <h1>Tabs <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/tabs">(source)</a></h1>
    <p>
...
@Component({
  ...
  template: `
    ...
    <p>
      The following are examples of know composition patterns to create a common user exeperience. The component library is design to be
      used in these patterns.
    </p>
    <h2>Activity Sections</h2>
    <p>Displaying a series of list data in ... blah, blah, blah</p>
...
@Component({
  ...
  template: `
    <h2>Bullhorn Application Templates</h2>
    <h2>Example starter templates for your application</h2>
    <h3>Email</h3>
    <p>List App</p>
    <p>TODO: Add linked image</p>
    <h3>Form App</h3>
    <p>form-based app template</p>
    <p>TODO: Add linked image</p>
    <h3>Custom Card Starter Template</h3>
    <p>empty starter template</p>
    <p>TODO: Add linked image</p>
    <h3>Dashboard</h3>
...
@Component({
  ...
  template: `
    <h1>Chomsky-NG2 Documentation</h1>
    ...
    <p>
      Other short formats include (bold is default):<br /><em>short - 02/14/2017, 1:17 PM</em><br /><em>medium - Feb 14, 2017, 1:17 PM</em
      ><br /><em>long - Febuary 14, 2017, 1:17 PM CST</em><br /><strong><em>dateShort - 02/14/2017</em></strong
      ><br /><em>dateMedium - Feb 14, 2017</em><br /><em>dateLong - Febuary 14, 2017</em><br /><em>timeShort - 1:17 PM</em><br /><em
        >timeLong - 1:17 PM CST</em
      >
    </p>
...
@Component({
  selector: 'modal-page',
  template: `
    <h1>Modals <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/modal">(source)</a></h1>
    <p>
      ...
      workflow. There are two categories of modals: notification and workflow. Regardless of type, a modal should have a maximum of two main
      buttons.
    </p>

...
@Component({
  ...
  template: `<h2>Covalent Templates</h2><h2>Example starter templates for your application</h2><h3>Email</h3><p>email app template</p><p><img src="https://firebasestorage.googleapis.com/v0/b/covalent-docs.appspot.com/o/templates%2Femail-template.png?alt=media&amp;token=71939419-fa18-4e49-b4e4-66b2fc79209f" alt="Email"></p><h3>Contacts</h3><p>contacts app template</p><p><img src="https://firebasestorage.googleapis.com/v0/b/covalent-docs.appspot.com/o/templates%2Fcontacts-template.png?alt=media&amp;token=f1a39208-616f-4e74-8fd3-93cee7e1972c" alt="Contacts"></p><h3>Slack Chat</h3><p>chat app template</p><p><img src="https://firebasestorage.googleapis.com/v0/b/covalent-docs.appspot.com/o/templates%2Fchat-template.png?alt=media&amp;token=af671e0f-d131-4ae8-8383-f51e9183a9f9" alt="Slack Chat"></p><h3>Landing Page</h3><p>landing page template</p><p><img src="https://firebasestorage.googleapis.com/v0/b/covalent-docs.appspot.com/o/templates%2Flanding-page-template.png?alt=media&amp;token=8b3961df-e87e-4d33-8068-74ee28dea184" alt="Landing Page"></p><h3>Starter Template</h3><p>empty starter template</p><p><img src="https://firebasestorage.googleapis.com/v0/b/covalent-docs.appspot.com/o/templates%2Fstarter-template.png?alt=media&amp;token=8b3961df-e87e-4d33-8068-74ee28dea184" alt="Starter Template"></p><h3>Dashboard</h3><p>dashboard template</p><p><img src="https://firebasestorage.googleapis.com/v0/b/covalent-docs.appspot.com/o/templates%2Fdashboard-template.png?alt=media&amp;token=f1a39208-616f-4e74-8fd3-93cee7e1972c" alt="Dashboard"></p>`,
})
...
const routes: Routes = [
  ...
  { path: 'src/components/quick-note', component: QuickNotePage, data: { title: 'Quick Note', section: 'components' } },
  { path: 'src/components/search', component: SearchPage, data: { title: 'Search', section: 'components' } },
  { path: 'src/components/slides', component: SlidesPage, data: { title: 'Slides', section: 'components' } },
  { path: 'src/components/switch', component: SwitchPage, data: { title: 'Switch', section: 'components' } },
  { path: 'src/components/table', component: TablePage, data: { title: 'Table', section: 'components' } },
  { path: 'src/design/colors', component: ColorsPage, data: { title: 'Colors', section: 'design' } },
  { path: 'src/design/composition', component: CompositionPage, data: { title: 'Composition', section: 'design' } },
  { path: 'src/design', component: DesignPage, data: { title: 'Design', section: 'src' } },
  { path: 'src/design/iconography', component: IconographyPage, data: { title: 'Iconography', section: 'design' } },
  { path: 'src/design/typography', component: TypographyPage, data: { title: 'Typography', section: 'design' } },
  { path: 'src/form-controls/chips', component: ChipsPage, data: { title: 'Chips', section: 'form-controls' } },
  { path: 'src/form-controls/date-picker', component: DatePickerPage, data: { title: 'Date Picker', section: 'form-controls' } },
  { path: 'src/form-controls/editor', component: EditorPage, data: { title: 'Editor', section: 'form-controls' } },
  { path: 'src/form-controls', component: FormControlsPage, data: { title: 'Form Controls', section: 'src' } },
  { path: 'src/form-controls/form-groups', component: FormGroupsPage, data: { title: 'Form Groups', section: 'form-controls' } },
  { path: 'src/form-controls/multi-picker', component: MultiPickerPage, data: { title: 'Multi Picker', section: 'form-controls' } },
  { path: 'src/form-controls/picker', component: PickerPage, data: { title: 'Picker', section: 'form-controls' } },
  { path: 'src/form-controls/radio-buttons', component: RadioButtonsPage, data: { title: 'Radio Buttons', section: 'form-controls' } },
  { path: 'src/form-controls/select', component: SelectPage, data: { title: 'Select', section: 'form-controls' } },
  { path: 'src/form-controls/tiles', component: TilesPage, data: { title: 'Tiles', section: 'form-controls' } },
  { path: 'src/form-controls/value', component: ValuePage, data: { title: 'Value', section: 'form-controls' } },
  { path: 'src', component: HomePage, data: { title: 'Home', section: 'novo-examples' } },
  { path: 'src/layouts/cards', component: CardsPage, data: { title: 'Cards', section: 'layouts' } },
  { path: 'src/layouts/expansion', component: ExpansionPage, data: { title: 'Expansion', section: 'layouts' } },
  { path: 'src/layouts/header', component: HeaderPage, data: { title: 'Header', section: 'layouts' } },
  { path: 'src/layouts', component: LayoutsPage, data: { title: 'Layouts', section: 'src' } },
  { path: 'src/layouts/list', component: ListPage, data: { title: 'List', section: 'layouts' } },
  { path: 'src/layouts/stepper', component: StepperPage, data: { title: 'Stepper', section: 'layouts' } },
  { path: 'src/layouts/tabs', component: TabsPage, data: { title: 'Tabs', section: 'layouts' } },
  ...
  { path: 'src/utils/modal', component: ModalPage, data: { title: 'Modal', section: 'utils' } },
  { path: 'src/utils/pipes', component: PipesPage, data: { title: 'Pipes', section: 'utils' } },
  { path: 'src/utils/pop-over', component: PopOverPage, data: { title: 'Pop Over', section: 'utils' } },
  { path: 'src/utils/security', component: SecurityPage, data: { title: 'Security', section: 'utils' } },
  { path: 'src/utils/tip-well', component: TipWellPage, data: { title: 'Tip Well', section: 'utils' } },
  { path: 'src/utils/toaster', component: ToasterPage, data: { title: 'Toaster', section: 'utils' } },
  // Catch All

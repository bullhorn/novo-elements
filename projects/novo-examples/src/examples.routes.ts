...
@Component({
  ...
  template: `<h1>Introduction</h1>
    ...
    <p>
      Are you a developer and want to skip right to the code?<br />
...
@Component({
  ...
  template: `<p>This is a drop-in collection of CSS styles to make simple websites like this just a little bit nicer.</p>
    <p>Now you can write your simple static site with nice semantic html, and will manage the styling for you.</p>
    <div class="row">
      <div>
    ...
    <p>
      The Waterize bookmarklet can be used to make ugly websites more readable by replacing the styles with. Just drag this link to your
      bookmarks bar:
    </p>
    <strong> test </strong>

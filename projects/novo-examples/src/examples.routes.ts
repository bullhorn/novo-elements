...
@Component({
  ...
  template: `<h1>🚀 February 2022 (version 6 - Golden)</h1>
    ...
    <ul>
      <li>
        <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#dev-principle">Development Principle</a> - Philosophy on why we are
        making these changes.
      </li>
      <li>
        <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#improved-docs">Improved Documentation</a> - Check out the new Design
        &amp; Developer Guideline.
      </li>
      <li>
        <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#design-tokens">Design Token &amp; Themes</a> - The Bullhorn brand has
        evolved and the design system.
      </li>
      <li>
        <strong>New Components</strong>
        <ul>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#aside">Aside</a> - A replacement implementation for Preview
            slideouts, that is easy to use and works like modals.
          </li>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#autocomplete">Autocomplete</a> - Low-level feature to help
            composability of custom pickers.
          </li>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#avatar">Avatar</a> - Display user and entity images with fallback
            display.
          </li>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#breadcrumbs">Breadcrumbs</a> - Show nested navigation hierarchy.
          </li>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#menu">Menu</a> - Coalesce options into floating overlay with a
            myriad of trigger functionality.
          </li>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#layouts">Layout</a> - Easy to setup layouts with side navigation.
          </li>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#color-picker">Color Picker</a> - Pick a color, works with form
            inputs.
          </li>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#toolbar">Toolbar</a> - More flexible toolbar control, to use for
            page headers or navigation.
          </li>
        </ul>
      </li>
      <li>
        ...
        <ul>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#calendar">Calendar</a> - Support for multi-day selection,
            multi-month view, and can now be used independant of the data picker.
          </li>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#modals">Modal</a> - New animation and more events to better
            control Modals.
          </li>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#chips">Chips</a> - Still a WIP, but Chip, ChipList and ChipInput
            are now independant components that can be composed together separately.
          </li>
          <li>
            <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#select">Select &amp; Dropdown</a> - Overhaul of these component
            to consolidate functionality into the new <code>novo-option</code> component, to create a more declarative design.
          </li>
        </ul>
      </li>
      <li>
        <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#preview-features">Preview Features</a> - Check some new features that
        are still in development.
      </li>
      <li>
        <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#notable-changes">Notable Changes</a> - We changed some things, we
        fixed some things, hopefully left everything better than before!
      </li>
    </ul>
    <blockquote>
      <div class="p">
    ...
    <p>
      This is a large update that helps clear a backlog of technical debt, there have been several breaking changes that should be covered
      with <code>ng update novo-elements --migrate-only --from=0.0.0 --to=6.0.0 --force --allow-dirty</code>.
    </p>
    <p>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">novo-select</span>&gt;</span>
    ...
    <h2 id="improved-documentation">
      Improved Documentation <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#improved-documentation">#</a>
    </h2>
    <p>
    ...
    <h2 id="design-tokens">
      Design Token &amp; Themes <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#design-tokens">#</a>
    </h2>
    <p>
    ...
    <h2 id="updated-components">
      Updated Components <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#updated-components">#</a>
    </h2>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">novo-select</span>&gt;</span>
    ...
    <h3 id="utility-directives">
      Utility Directives <a href="https://bullhorn.github.io/novo-elements/#/updates/v6#utility-directives">#</a>
    </h3>
    <p>

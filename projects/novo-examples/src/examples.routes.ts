...
@Component({
  selector: 'menu-page',
  template: `<h1>Menu <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/dropdown">(source)</a></h1>
<p>Menu allow users to take an action by selecting from a list of choices revealed upon opening a temporary menu.</p>
<h2>Types</h2>
<h5>Basic Menu</h5>
<p>This is a simple menu.</p>
...
@Component({
  ...
  template: `<h1>PopOvers <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/popover">(source)</a></h1>
...
@Component({
  ...
  template: `<h1>Tooltips <a href="https://github.com/bullhorn/novo-elements/blob/master/projects/novo-elements/src/elements/tooltip">(source)</a></h1>
<h2>Helper</h2>
...
const routes: Routes = [
  ...
  },
  {
    ...
    component: TabsLayout,
    data: { title: 'Button', section: 'components', pages: [{ title: 'Usage', route: './usage'},{ title: 'Design', route: './design'},{ title: 'Develop', route: './develop'},{ title: 'Examples', route: './examples'}] },
    children: [
  ...
  },
  {
    ...
    component: TabsLayout,
    data: { title: 'Menu', section: 'components', pages: [{ title: 'Usage', route: './usage'},{ title: 'Design', route: './design'},{ title: 'Develop', route: './develop'},{ title: 'Examples', route: './examples'},{ title: 'Menu', route: './menu'}] },
    children: [
  ...
  { path: 'utils/tip-well', component: TipWellPage, data: { title: 'Tip Well', section: 'utils' } },
  {
    path: 'utils/toaster',
    component: TabsLayout,
    data: { title: 'Toaster', section: 'utils', pages: [{ title: 'Usage', route: './usage'},{ title: 'Design', route: './design'},{ title: 'Develop', route: './develop'},{ title: 'Examples', route: './examples'}] },
    children: [
...
export const PAGE_LIST = [
  AceEditorPage,AutocompleteDesignPage,AutocompleteDevelopPage,AutocompleteExamplesPage,AutocompleteUsagePage,AvatarDesignPage,AvatarDevelopPage,AvatarExamplesPage,AvatarUsagePage,BreadcrumbDesignPage,BreadcrumbDevelopPage,BreadcrumbExamplesPage,BreadcrumbUsagePage,ButtonDesignPage,ButtonDevelopPage,ButtonExamplesPage,ButtonUsagePage,CalendarPage,ComponentsPage,DataTablePage,DropdownDesignPage,DropdownDevelopPage,DropdownExamplesPage,DropdownUsagePage,FieldDesignPage,FieldDevelopPage,FieldExamplesPage,FieldUsagePage,IconDesignPage,IconDevelopPage,IconExamplesPage,IconUsagePage,IconPage,LoadingDesignPage,LoadingDevelopPage,LoadingExamplesPage,LoadingUsagePage,MenuDesignPage,MenuDevelopPage,MenuExamplesPage,MenuUsagePage,MenuPage,NonIdealStateDesignPage,NonIdealStateDevelopPage,NonIdealStateExamplesPage,NonIdealStateUsagePage,ProgressDesignPage,ProgressDevelopPage,ProgressExamplesPage,ProgressUsagePage,QuickNotePage,SearchPage,SlidesPage,SwitchPage,TabbedGroupPickerPage,TablePage,ColorsPage,CompositionPage,DesignPage,IconographyPage,SpacingPage,TypographyPage,ChipsPage,ColorPickerPage,DatePickerDesignPage,DatePickerDevelopPage,DatePickerExamplesPage,DatePickerUsagePage,DatePickerPage,DateTimePickerDesignPage,DateTimePickerDevelopPage,DateTimePickerExamplesPage,DateTimePickerUsagePage,EditorPage,FormControlsPage,FormGroupsPage,FormPage,MultiPickerPage,PickerPage,RadioButtonsPage,SelectPage,TilesPage,TimePickerDesignPage,TimePickerDevelopPage,TimePickerExamplesPage,TimePickerUsagePage,ValuePage,HomePage,CardDesignPage,CardDevelopPage,CardExamplesPage,CardUsagePage,ExpansionPage,HeaderPage,LayoutsPage,ListPage,SidenavPage,StepperPage,TabsDesignPage,TabsDevelopPage,TabsExamplesPage,TabsUsagePage,PatternsNativeFormsPage,PatternsTestPage,PatternsPage,TemplatesPage,AsideDesignPage,AsideDevelopPage,AsideExamplesPage,AsideUsagePage,ChomskyPage,FieldInteractionsPage,ModalDesignPage,ModalDevelopPage,ModalExamplesPage,ModalUsagePage,PipesPage,PopOverPage,SecurityPage,TipWellPage,ToasterDesignPage,ToasterDevelopPage,ToasterExamplesPage,ToasterUsagePage,TooltipPage
];

  ...
  template: `<h2>Usage</h2>
    ...
    <novo-grid columns="2" align="start" gap="2rem">
      ...
      <blockquote>
        <div class="p"><strong>Placement</strong></div>
        <div class="p">
          A tooltip is positioned in relation to its target. Placement property values are at the: top, top left, top right, top start, top
          end, bottom, bottom left, bottom right, bottom start, bottom end, left, left top, left bottom, start, start top, start bottom,
          right, right top, right bottom, end, end top, end bottom. The default placement value is at the top.
        </div>
      </blockquote>
      <p><img src="https://via.placeholder.com/250x200" alt="placeholder" /></p>
    </novo-grid> `,

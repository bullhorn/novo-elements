...
/** Entry point for the migration schematics with target of Novo Elements v8 */
export function updateToV8(): Rule {
  return createMigrationSchematicRule(TargetVersion.V8, novoElementMigrations, elementsUpgradeData, onMigrationComplete);
}

...
describe('NovoExpansionPanel', () => {
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [NoopAnimationsModule, NovoExpansionModule],
      declarations: [
        PanelWithContent,
  ...
  it('should be able to hide the toggle', () => {
    ...
    expect(header.querySelector('.novo-expansion-indicator')).toBeTruthy('Expected indicator to be shown.');

    fixture.componentInstance.hideToggle = true;
    fixture.detectChanges();

    expect(header.querySelector('.novo-expansion-indicator')).toBeFalsy('Expected indicator to be hidden.');
  });
  ...
  it('should not set the novo-expanded class until the open animation is done', fakeAsync(() => {
    ...
    fixture.detectChanges();
    expect(contentEl.classList).not.toContain('novo-expanded', 'Expected class not to be there on init');

    fixture.componentInstance.expanded = true;
    fixture.detectChanges();
    expect(contentEl.classList).not.toContain('novo-expanded', 'Expected class not to be added immediately after becoming expanded');

    flush();
    expect(contentEl.classList).toContain('novo-expanded', 'Expected class to be added after the animation has finished');
  }));

...
// import { FormInput, CheckList } from '../FormExtras';
//
// @Component({
//     selector: 'test-cmp',
//     directives: [FormInput, CheckList],
//     template: `
//     <form-input type="checkbox" [options]="options"></form-input>
// `
// })
// class TestCmp {
//     constructor() {
...
//     beforeEach(done => {
//         setTimeout(() => {
//             const cmpDebugElement = ctx.fixture.debugElement.query(By.directive(CheckList));

...
// import { FormInput, CurrencyInput } from '../FormExtras';
//
// @Component({
//     selector: 'test-cmp',
//     directives: [FormInput, CurrencyInput],
//     template: `
//     <form-input type="money"></form-input>
// `
// })
// class TestCmp {
//     constructor() {
...
// }
//
// describe('Element: CurrencyInput', () => {
//     let ctx;
//     let instance;
//     let cmpElement;
//     let cmpInstance;
...
//     beforeEach(done => {
//         setTimeout(() => {
//             const cmpDebugElement = ctx.fixture.debugElement.query(By.directive(CurrencyInput));

...
// import { FormInput, EntityChipsInput } from '../FormExtras';
//
// @Component({
//     selector: 'test-cmp',
//     directives: [FormInput, EntityChipsInput],
//     template: `
//     <form-input type="entity" multiple="true"></form-input>
// `
// })
// class TestCmp {
//     constructor() {
...
// }
//
// describe('Element: EntityChipsInput', () => {
//     let ctx;
//     let instance;
//     let cmpElement;
//     let cmpInstance;
...
//     beforeEach(done => {
//         setTimeout(() => {
//             const cmpDebugElement = ctx.fixture.debugElement.query(By.directive(EntityChipsInput));

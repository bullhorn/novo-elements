...
// import { FormInput, CheckBox } from '../FormExtras';
//
// @Component({
//     selector: 'test-cmp',
//     directives: [FormInput, CheckBox],
//     template: `
...
//     beforeEach(done => {
//         setTimeout(() => {
//             const cmpDebugElement = ctx.fixture.debugElement.query(By.directive(CheckBox));

...
// import { FormInput, EntityInput } from '../FormExtras';
//
// @Component({
//     selector: 'test-cmp',
//     directives: [FormInput, EntityInput],
//     template: `
//     <form-input type="entity"></form-input>
// `
// })
// class TestCmp {
//     constructor() {
...
//     beforeEach(done => {
//         setTimeout(() => {
//             const cmpDebugElement = ctx.fixture.debugElement.query(By.directive(EntityInput));

...
// import { FormInput, TimeInput } from '../FormExtras';
//
// @Component({
//     selector: 'test-cmp',
//     directives: [FormInput, TimeInput],
//     template: `
//     <form-input type="time"></form-input>
// `
// })
// class TestCmp {
//     constructor() {
...
//     beforeEach(done => {
//         setTimeout(() => {
//             const cmpDebugElement = ctx.fixture.debugElement.query(By.directive(TimeInput));

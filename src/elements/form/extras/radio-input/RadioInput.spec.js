...
// import { FormInput, RadioInput } from '../FormExtras';
//
// @Component({
//     selector: 'test-cmp',
//     directives: [FormInput, RadioInput],
//     template: `
//     <form-input type="radio" [options]="options"></form-input>
// `
// })
// class TestCmp {
//     constructor() {
...
//     beforeEach(done => {
//         setTimeout(() => {
//             const cmpDebugElement = ctx.fixture.debugElement.query(By.directive(RadioInput));

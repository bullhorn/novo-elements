...
// import { FormInput, FloatInput } from '../FormExtras';
//
// @Component({
//     selector: 'test-cmp',
//     directives: [FloatInput, FormInput],
//     template: `
//     <form-input type="float"></form-input>
// `
// })
// class TestCmp {
//     constructor() {
...
//     beforeEach(done => {
//         setTimeout(() => {
//             const cmpDebugElement = ctx.fixture.debugElement.query(By.directive(FloatInput));

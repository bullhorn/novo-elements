            ...
            <div class="novo-control-input-container">
                ...
                <div class="novo-control-input {{control.controlType}}" [ngSwitch]="control.controlType" [attr.data-automation-id]="control.key">
                    ...
                    <div class="novo-control-input-container novo-control-input-with-label" *ngSwitchCase="'textbox'">
                        <input [formControlName]="control.key" [id]="control.key" [type]="control.type" [placeholder]="control.placeholder" (input)="emitChange($event)" [maxlength]="control.maxlength" (focus)="handleFocus($event)" (blur)="handleBlur($event)">
                    ...
                    <div class="novo-control-input-container" *ngSwitchCase="'picker'">
                        ...
                        <chips [source]="control.config" [type]="control.config.type" [formControlName]="control.key" [placeholder]="control.placeholder" *ngIf="control.multiple" (changed)="modelChange($event)" (typing)="handleTyping($event)"></chips>
                    </div>
                    <!--Novo Select-->

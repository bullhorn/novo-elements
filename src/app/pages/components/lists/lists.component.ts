...
export class ListsComponent {
  ...
  public name: string = 'Lists';
  public src: string = 'https://github.com/bullhorn/novo-elements-3.0/tree/master/src/platform/core/components/lists';
  public usageDoc: string = usageDoc;
  public demos: DEMOS = LISTS_DEMOS;
}

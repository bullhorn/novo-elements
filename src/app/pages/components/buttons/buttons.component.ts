...
import { BUTTON_DEMOS } from './demos';
...
export class ButtonsComponent {
  ...
  public src: string = 'https://github.com/bullhorn/novo-elements-3.0/tree/master/src/platform/core/components/buttons';
  public usageDoc: string = usageDoc;
  public demos: DEMOS = BUTTON_DEMOS;
}

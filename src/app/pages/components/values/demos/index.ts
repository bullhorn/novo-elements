import { DemoValueStandardComponent } from './standard/standard';
// import { DemoListAdvancedComponent } from './advanced/advanced';
// import { DemoListEntityComponent } from './entity/entity';

export const VALUES_DEMO_COMPONENTS: any[] = [
  DemoValueStandardComponent,
  // DemoListAdvancedComponent,
  // DemoListEntityComponent,
];

export const VALUES_DEMOS: DEMOS = {
  standard: {

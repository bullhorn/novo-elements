...
// Vendor
import { DateCell, PercentageCell, BaseRenderer, NovoTableElement, NovoTableConfig, TextBoxControl, TablePickerControl, SelectControl, NovoDropdownCell } from './../../../../platform/index';
    ...
    constructor() {
        ...
        this.editable = {
            columns: [
                ...
                {
                    title: 'Job Type', name: 'jobType', ordering: true, filtering: true, options: ['Freelance', 'Contact', 'Billable'], multiple: true, editorType: 'SelectControl', editorConfig: { key: 'jobType', options: [{ value: 'Freelance', label: 'Freelance' }, { value: 'Contract', label: 'Contract' }, { value: 'Billable', label: 'Billable' }] }
                },
                {
                    title: 'Rate',
                    name: 'rate',

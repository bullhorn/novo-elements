...
export class DropdownDemoComponent {
  ...
  public POSITION_OPTIONS: { name: string, description: string }[] = [
    { name: 'default', description: 'Prefer bottom-left, with fallback positions (in order): top-left, bottom-right, top-right' },
    { name: 'right', description: 'Prefer bottom-right, with fallback positions (in order): top-right, bottom-left, top-left' },

...
import { SkillSpecialtyPickerResults } from '../../elements/picker/extras/skills-picker-results/SkillsSpecialtyPickerResults';
        ...
        switch (entity) {
            ...
            case 'Specialty':
                ...
                return {
                    ...
                    resultsTemplate: SkillSpecialtyPickerResults,

...
describe('Elements: NovoValueElement', () => {
  ...
  describe('oninit ', () => {
    ...
    it('should setup retrieveTextHandler to be called when retrieveText is received', () => {
      spyOn(component, 'retrieveTextHandler').and.callThrough();
      component.ngOnInit();
      component.retrieveText.next(true);
      expect(component.retrieveTextHandler).toHaveBeenCalled();
    });
  });
  ...
  describe('Function: retrieveTextHandler', () => {
    it('should call onRetrieveText with rendered text', () => {
      spyOn(component.onRetrieveText, 'emit').and.callThrough();
      component.data = '<span style="color:#8e44ad">test</span>';
      component.meta = {};
      component.retrieveTextHandler();
      expect(component.onRetrieveText.emit).toHaveBeenCalledWith('test');
    });
  });

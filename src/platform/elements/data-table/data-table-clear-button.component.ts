...
export class NovoDataTableClearButton<T> {
  @Output() sortClear: EventEmitter<boolean> = new EventEmitter();
  @Output() filterClear: EventEmitter<boolean> = new EventEmitter();
  @Output() allClear: EventEmitter<boolean> = new EventEmitter();

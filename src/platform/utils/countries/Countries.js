...
function getCountries() {
    return exports.COUNTRIES.map(function (country) { return country.name; });
}
...
function findByCountryId(id) {
    return exports.COUNTRIES.find(function (country) { return country.id === id; });
}
...
function findByCountryName(name) {
    return exports.COUNTRIES.find(function (country) { return country.name === name.trim(); });
}
...
function findByCountryCode(code) {
    return exports.COUNTRIES.find(function (country) { return country.code === code.trim(); });
}
...
function getStateObjects(name) {
    var foundCountry = exports.COUNTRIES.find(function (country) { return country.name === name.trim(); });

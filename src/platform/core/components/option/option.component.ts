// NG2
import { Component, ChangeDetectorRef, Input, Output, EventEmitter, ElementRef, HostBinding, HostListener } from '@angular/core';
...
export class NovoOptionComponent {
    ...
    @Output() public selection: EventEmitter<NovoSelectionEvent> = new EventEmitter<NovoSelectionEvent>();

...
import { findByCountryId } from '../../utils/countries/countries.service';
import { EntityUtils } from '../../utils/entity-utils/entity-utils.service';
...
export class RenderPipe implements PipeTransform {
   ...
   * @return text
   */
  public render(value: any, args?: any): any {
    let type: any;
    let text: any = value;
    ...
    switch (type) {
      ...
      case 'AddressWithoutCountry':
        ...
        break;
      case 'DateTime':
        text = this.labels.formatDateTime(value);
        break;
      case 'Timestamp':
  ...
  public updateValue(value: any, args: any): any {
   ...
   * @return {String}
   */
  public concat(list: any, ...fields: any[]): any {
    let data: any = [];
   ...
   * @return {String}
   */
  public options(value: any, list: any): any {
    try {
  ...
  public getNumberDecimalPlaces(value: any): any {

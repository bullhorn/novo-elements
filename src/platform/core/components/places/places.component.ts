...
export class PlacesListComponent implements OnInit, OnChanges {
    ...
    @Output() public termChange: EventEmitter<any> = new EventEmitter<any>();
    ...
    public searchinputClickCallback(event: any): any {
        event.target.select();
        this.searchinputCallback(event);
    }

    // function called when there is a change in input. (Binded with view)
    public searchinputCallback(event?: any): any {
    ...
    public activeListNode(index: number): any {
    ...
    public selectedListNode(event: MouseEvent, index: number): any {
        this.dropdownOpen = false;
    ...
    public userQuerySubmit(selectedOption?: any): any {
    ...
    public currentLocationSelected(): any {
    ...
    private getListQuery(value: string): any {
        ...
        if (this.settings.useGoogleGeoApi) {
            ...
            this._googlePlacesService.getGeoPrediction(_tempParams).then((result: any) => {
                this.updateListItem(result);
            });
        } else {
            this._googlePlacesService.getPredictions(this.settings.geoPredictionServerUrl, value).then((result: any) => {

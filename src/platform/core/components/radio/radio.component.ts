// NG2
import { Component, EventEmitter, forwardRef, Input, HostBinding, Output, ChangeDetectorRef } from '@angular/core';
...
export class NovoRadioComponent implements ControlValueAccessor {
    @HostBinding('class.vertical') @Input() public vertical: boolean = false;

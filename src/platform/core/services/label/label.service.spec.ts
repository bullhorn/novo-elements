import { NovoLabelService } from './label.service';

describe('Service: NovoLabelService', () => {
  let service: NovoLabelService;
  ...
  beforeEach(() => {
    ...
    expect(service.invalidMaxLength).toBeDefined();
    expect(service.maxLengthMet).toBeDefined();
  ...
  describe('Method: selectedRecords()', () => {
    ...
    it('should return correct value.', () => {
      let value: string = 'Only 1 records selected.';
      expect(service.selectedRecords(1)).toEqual(value);
    });
  });
  ...
  describe('Method: totalRecords()', () => {
    ...
    it('should return correct value.', () => {
      let value: string = 'Select all 10 matching records.';
      expect(service.totalRecords(10)).toEqual(value);
    });
  });
  ...
  describe('Method: getProperty()', () => {
    ...
    it('should return correct value.', () => {
      expect(service.getProperty('next')).toEqual('Next');
    });
  });
});

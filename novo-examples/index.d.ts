...
interface CustomParams$1 {
    id: number;
    name: string;
}
declare class AsideCustomDemo {
    ref: NovoAsideRef<CustomParams$1, string>;
    values: {
        label: string;
        data: string;
    }[];
    constructor(ref: NovoAsideRef<CustomParams$1, string>);
    close(): void;
...
declare class AsideWidgetDemo {
    ...
    preventDrag(): void;
    enableDrag(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<AsideWidgetDemo, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<AsideWidgetDemo, "aside-widget-demo", never, {}, {}, never, never, false, never>;
}
/**
 * @title Aside Usage Example
 */
declare class AsideWidgetExample {
    private aside;
    asideRef: any;
    constructor(aside: NovoAsideService);
    toggleAside(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<AsideWidgetExample, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<AsideWidgetExample, "aside-widget-example", never, {}, {}, never, never, false, never>;
}
...
/**
 * @title Icon buttons with label
 */
declare class ButtonIconLabelExample {
    static ɵfac: i0.ɵɵFactoryDeclaration<ButtonIconLabelExample, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<ButtonIconLabelExample, "button-icon-label-example", never, {}, {}, never, never, false, never>;
}
...
declare class MenuContextExample {
    ...
    clickMe(item?: any, event?: any): void;
 ...
 * @title Tabbed Group Picker - Basic Example
 */
declare class TabbedGroupPickerChipsExample implements OnInit {
    getAnimals: () => {
        animalId: number;
        name: string;
    }[];
    ...
    ngOnInit(): void;
    onSelectionChange(selectedData: TabbedGroupPickerTab[]): void;
    resetState([animalsTab, placesTab, colorsTab]: TabbedGroupPickerTab[]): void;
    buildButtonLabel(): string;
    static ɵfac: i0.ɵɵFactoryDeclaration<TabbedGroupPickerChipsExample, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<TabbedGroupPickerChipsExample, "tabbed-group-picker-chips-example", never, {}, {}, never, never, false, never>;
}
 ...
 */
declare class TabbedGroupPickerIconChipsExample implements OnInit {
    getAnimals: () => {
        animalId: number;
        name: string;
    }[];
    ...
    ngOnInit(): void;
    onSelectionChange(selectedData: TabbedGroupPickerTab[]): void;
    resetState([animalsTab, placesTab]: TabbedGroupPickerTab[]): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<TabbedGroupPickerIconChipsExample, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<TabbedGroupPickerIconChipsExample, "tabbed-group-picker-icon-chips-example", never, {}, {}, never, never, false, never>;
}
 ...
 */
declare class CompactTipWellExample {
    demoTip: string;
    clearLocalStorage(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<CompactTipWellExample, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<CompactTipWellExample, "compact-tip-well-example", never, {}, {}, never, never, false, never>;
}
 ...
 */
declare class TooltipPrelineExample {
    multiLineTooltip: string;
    static ɵfac: i0.ɵɵFactoryDeclaration<TooltipPrelineExample, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<TooltipPrelineExample, "tooltip-preline-example", never, {}, {}, never, never, false, never>;
}
 ...
 * @title Basic Cards
 */
declare class BasicCardExample implements AfterViewInit {
    private toaster;
    refresh: boolean;
    close: boolean;
    move: boolean;
...
/**
 * @title Color/Neutral Theme Tabs
 */
declare class TabsNeutralExample {
    static ɵfac: i0.ɵɵFactoryDeclaration<TabsNeutralExample, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<TabsNeutralExample, "tabs-neutral-example", never, {}, {}, never, never, false, never>;
}

/**
 * @title Nav Link Tabs (Router Style)
 */
declare class TabsNavLinkExample {
    static ɵfac: i0.ɵɵFactoryDeclaration<TabsNavLinkExample, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<TabsNavLinkExample, "tabs-nav-link-example", never, {}, {}, never, never, false, never>;
}
...
/**
 * @title Button Bar Tabs
 */
declare class TabsButtonBarExample {
    static ɵfac: i0.ɵɵFactoryDeclaration<TabsButtonBarExample, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<TabsButtonBarExample, "tabs-button-bar-example", never, {}, {}, never, never, false, never>;
}
 ...
 */
declare class BasicCollapsibleNavExample {
    collapsed: boolean;
    openWindows: {
        accent: string;
        label: string;
    }[];
    onManualExpansion(event: CollapsibleNavExpansionEvent): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<BasicCollapsibleNavExample, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<BasicCollapsibleNavExample, "basic-collapsible-nav-example", never, {}, {}, never, never, false, never>;
}
...
declare class NovoExamplesSharedModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<NovoExamplesSharedModule, [typeof CodeSnippetComponent, typeof CodeExampleComponent, typeof TypedefContent, typeof TypedefExample, typeof TypedefSnippet, typeof TypedefSpec, typeof FigureExample, typeof TabsLayout, typeof DefaultLayout], [typeof i1.RouterModule, typeof i236.FormsModule, typeof i236.ReactiveFormsModule, typeof i237.CommonModule, typeof i10.AngularSplitModule, typeof i238.NovoElementsModule, typeof i12.PortalModule], [typeof CodeSnippetComponent, typeof CodeExampleComponent, typeof TypedefContent, typeof TypedefExample, typeof TypedefSnippet, typeof TypedefSpec, typeof FigureExample, typeof TabsLayout, typeof DefaultLayout]>;
...
declare class v13Page {
    params: any;
    static ɵfac: i0.ɵɵFactoryDeclaration<v13Page, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<v13Page, "v13-page", never, {}, {}, never, never, false, never>;
}
...
declare class CollapsibleNavPage {
    params: any;
    static ɵfac: i0.ɵɵFactoryDeclaration<CollapsibleNavPage, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<CollapsibleNavPage, "collapsible-nav-page", never, {}, {}, never, never, false, never>;
}
